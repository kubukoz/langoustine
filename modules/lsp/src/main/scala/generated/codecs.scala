...
private[lsp] trait requests_callHierarchy_incomingCalls:
  ...
  given outputToJson: Encoder[Out] =
    Encoder.encodeOption(
      Encoder.encodeVector(structures.CallHierarchyIncomingCall.toJson)
    )

  given outputFromJson: Decoder[Out] =
    Decoder.decodeOption(
      Decoder.decodeVector(structures.CallHierarchyIncomingCall.fromJson)
    )
end requests_callHierarchy_incomingCalls
...
private[lsp] trait requests_callHierarchy_outgoingCalls:
  ...
  given outputToJson: Encoder[Out] =
    Encoder.encodeOption(
      Encoder.encodeVector(structures.CallHierarchyOutgoingCall.toJson)
    )

  given outputFromJson: Decoder[Out] =
    Decoder.decodeOption(
      Decoder.decodeVector(structures.CallHierarchyOutgoingCall.fromJson)
    )
end requests_callHierarchy_outgoingCalls
...
end requests_client_registerCapability
...
private[lsp] trait requests_client_unregisterCapability:
  ...
  given outputFromJson: Decoder[Out] =
    Decoder.const[Null](null)
end requests_client_unregisterCapability
...
private[lsp] trait requests_codeAction_resolve:
  ...
  given outputFromJson: Decoder[Out] =
    structures.CodeAction.fromJson
end requests_codeAction_resolve
...
private[lsp] trait requests_completionItem_resolve:
  ...
  given outputFromJson: Decoder[Out] =
    structures.CompletionItem.fromJson
end requests_completionItem_resolve
...
private[lsp] trait requests_documentLink_resolve:
  ...
  given outputFromJson: Decoder[Out] =
    structures.DocumentLink.fromJson
end requests_documentLink_resolve
...
private[lsp] trait requests_inlayHint_resolve:
  ...
  given outputFromJson: Decoder[Out] =
    structures.InlayHint.fromJson
end requests_inlayHint_resolve
  ...
  given outputToJson: Encoder[Out] =
    Encoder.encodeOption(
      Encoder.encodeVector(
        Enc.union2[structures.Command, structures.CodeAction](
          structures.Command.toJson,
          structures.CodeAction.toJson
        )
      )
    )
  ...
  given outputFromJson: Decoder[Out] =
    Decoder.decodeOption(
      Decoder.decodeVector(
        Dec.union2[structures.Command, structures.CodeAction](
          structures.Command.fromJson,
          structures.CodeAction.fromJson
        )
      )
    )
end requests_textDocument_codeAction
...
end requests_textDocument_codeLens
...
end requests_textDocument_colorPresentation
...
private[lsp] trait requests_textDocument_completion:
  ...
  given outputToJson: Encoder[Out] =
    Encoder.encodeOption(
      Enc.union2[Vector[structures.CompletionItem], structures.CompletionList](
        Encoder.encodeVector(structures.CompletionItem.toJson),
        structures.CompletionList.toJson
      )
    )

  given outputFromJson: Decoder[Out] =
    Decoder.decodeOption(
      Dec.union2[Vector[structures.CompletionItem], structures.CompletionList](
        Decoder.decodeVector(structures.CompletionItem.fromJson),
        structures.CompletionList.fromJson
      )
    )
end requests_textDocument_completion
...
private[lsp] trait requests_textDocument_declaration:
  ...
  given outputToJson: Encoder[Out] =
    Encoder.encodeOption(
      Enc.union2[aliases.Declaration, Vector[aliases.DeclarationLink]](
        aliases.Declaration.toJson,
        Encoder.encodeVector(aliases.DeclarationLink.toJson)
      )
    )

  given outputFromJson: Decoder[Out] =
    Decoder.decodeOption(
      Dec.union2[aliases.Declaration, Vector[aliases.DeclarationLink]](
        aliases.Declaration.fromJson,
        Decoder.decodeVector(aliases.DeclarationLink.fromJson)
      )
    )
end requests_textDocument_declaration
...
private[lsp] trait requests_textDocument_definition:
  ...
  given outputToJson: Encoder[Out] =
    Encoder.encodeOption(
      Enc.union2[aliases.Definition, Vector[aliases.DefinitionLink]](
        aliases.Definition.toJson,
        Encoder.encodeVector(aliases.DefinitionLink.toJson)
      )
    )

  given outputFromJson: Decoder[Out] =
    Decoder.decodeOption(
      Dec.union2[aliases.Definition, Vector[aliases.DefinitionLink]](
        aliases.Definition.fromJson,
        Decoder.decodeVector(aliases.DefinitionLink.fromJson)
      )
    )
end requests_textDocument_definition
...
end requests_textDocument_diagnostic
...
end requests_textDocument_documentColor
...
private[lsp] trait requests_textDocument_documentHighlight:
  ...
  given outputToJson: Encoder[Out] =
    Encoder.encodeOption(
      Encoder.encodeVector(structures.DocumentHighlight.toJson)
    )

  given outputFromJson: Decoder[Out] =
    Decoder.decodeOption(
      Decoder.decodeVector(structures.DocumentHighlight.fromJson)
    )
end requests_textDocument_documentHighlight
...
end requests_textDocument_documentLink
...
private[lsp] trait requests_textDocument_documentSymbol:
  ...
  given outputFromJson: Decoder[Out] =
    Decoder.decodeOption(
      Dec.union2[Vector[structures.SymbolInformation], Vector[
        structures.DocumentSymbol
      ]](
        Decoder.decodeVector(structures.SymbolInformation.fromJson),
        Decoder.decodeVector(structures.DocumentSymbol.fromJson)
      )
    )
end requests_textDocument_documentSymbol
...
end requests_textDocument_foldingRange
...
end requests_textDocument_formatting
...
end requests_textDocument_hover
...
end requests_textDocument_implementation
...
end requests_textDocument_inlineValue
...
end requests_textDocument_linkedEditingRange
...
end requests_textDocument_moniker
...
private[lsp] trait requests_textDocument_onTypeFormatting:
  ...
  given outputFromJson: Decoder[Out] =
    Decoder.decodeOption(Decoder.decodeVector(structures.TextEdit.fromJson))
end requests_textDocument_onTypeFormatting
...
private[lsp] trait requests_textDocument_prepareCallHierarchy:
  ...
  given outputToJson: Encoder[Out] =
    Encoder.encodeOption(
      Encoder.encodeVector(structures.CallHierarchyItem.toJson)
    )

  given outputFromJson: Decoder[Out] =
    Decoder.decodeOption(
      Decoder.decodeVector(structures.CallHierarchyItem.fromJson)
    )
end requests_textDocument_prepareCallHierarchy
...
end requests_textDocument_prepareRename
...
private[lsp] trait requests_textDocument_prepareTypeHierarchy:
  ...
  given outputToJson: Encoder[Out] =
    Encoder.encodeOption(
      Encoder.encodeVector(structures.TypeHierarchyItem.toJson)
    )

  given outputFromJson: Decoder[Out] =
    Decoder.decodeOption(
      Decoder.decodeVector(structures.TypeHierarchyItem.fromJson)
    )
end requests_textDocument_prepareTypeHierarchy
...
end requests_textDocument_references
...
end requests_textDocument_rename
...
private[lsp] trait requests_textDocument_selectionRange:
  ...
  given outputFromJson: Decoder[Out] =
    Decoder.decodeOption(
      Decoder.decodeVector(structures.SelectionRange.fromJson)
    )
end requests_textDocument_selectionRange
...
end requests_textDocument_semanticTokens_full
...
private[lsp] trait requests_textDocument_semanticTokens_full_delta:
  ...
  given outputToJson: Encoder[Out] =
    Encoder.encodeOption(
      Enc.union2[structures.SemanticTokens, structures.SemanticTokensDelta](
        structures.SemanticTokens.toJson,
        structures.SemanticTokensDelta.toJson
      )
    )

  given outputFromJson: Decoder[Out] =
    Decoder.decodeOption(
      Dec.union2[structures.SemanticTokens, structures.SemanticTokensDelta](
        structures.SemanticTokens.fromJson,
        structures.SemanticTokensDelta.fromJson
      )
    )
end requests_textDocument_semanticTokens_full_delta
...
private[lsp] trait requests_textDocument_semanticTokens_range:
  ...
  given outputFromJson: Decoder[Out] =
    Decoder.decodeOption(structures.SemanticTokens.fromJson)
end requests_textDocument_semanticTokens_range
...
end requests_textDocument_signatureHelp
...
end requests_textDocument_typeDefinition
...
private[lsp] trait requests_textDocument_willSaveWaitUntil:
  ...
  given outputFromJson: Decoder[Out] =
    Decoder.decodeOption(Decoder.decodeVector(structures.TextEdit.fromJson))
end requests_textDocument_willSaveWaitUntil
...
end requests_typeHierarchy_subtypes
...
end requests_typeHierarchy_supertypes
...
end requests_window_showDocument
...
end requests_window_showMessageRequest
...
private[lsp] trait requests_window_workDoneProgress_create:
  ...
  given outputFromJson: Decoder[Out] =
    Decoder.const[Null](null)
end requests_window_workDoneProgress_create
...
end requests_workspace_applyEdit
...
private[lsp] trait requests_workspace_codeLens_refresh:
  ...
  given outputFromJson: Decoder[Out] =
    Decoder.const[Null](null)
end requests_workspace_codeLens_refresh
...
end requests_workspace_configuration
...
end requests_workspace_diagnostic
...
private[lsp] trait requests_workspace_diagnostic_refresh:
  ...
  given outputFromJson: Decoder[Out] =
    Decoder.const[Null](null)
end requests_workspace_diagnostic_refresh
...
private[lsp] trait requests_workspace_inlayHint_refresh:
  ...
  given outputFromJson: Decoder[Out] =
    Decoder.const[Null](null)
end requests_workspace_inlayHint_refresh
...
private[lsp] trait requests_workspace_inlineValue_refresh:
  ...
  given outputFromJson: Decoder[Out] =
    Decoder.const[Null](null)
end requests_workspace_inlineValue_refresh
...
private[lsp] trait requests_workspace_semanticTokens_refresh:
  ...
  given outputFromJson: Decoder[Out] =
    Decoder.const[Null](null)
end requests_workspace_semanticTokens_refresh
  ...
  given outputFromJson: Decoder[Out] =
    Decoder.decodeOption(
      Dec.union2[Vector[structures.SymbolInformation], Vector[
        ...
        Decoder.decodeVector(structures.SymbolInformation.fromJson),
        Decoder.decodeVector(structures.WorkspaceSymbol.fromJson)
      )
    )
...
private[lsp] trait requests_workspace_willCreateFiles:
  ...
  given outputFromJson: Decoder[Out] =
    Decoder.decodeOption(structures.WorkspaceEdit.fromJson)
end requests_workspace_willCreateFiles
...
private[lsp] trait requests_workspace_willDeleteFiles:
  ...
  given outputFromJson: Decoder[Out] =
    Decoder.decodeOption(structures.WorkspaceEdit.fromJson)
end requests_workspace_willDeleteFiles
...
private[lsp] trait requests_workspace_willRenameFiles:
  ...
  given outputFromJson: Decoder[Out] =
    Decoder.decodeOption(structures.WorkspaceEdit.fromJson)
end requests_workspace_willRenameFiles
...
end requests_workspace_workspaceFolders
...
private[lsp] trait requests_workspaceSymbol_resolve:
  ...
  given outputFromJson: Decoder[Out] =
    structures.WorkspaceSymbol.fromJson
end requests_workspaceSymbol_resolve
...
end structures_AnnotatedTextEditCodec
...
end structures_ApplyWorkspaceEditResultCodec
...
private[lsp] trait structures_BaseSymbolInformationCodec:
  ...
  given fromJson: Decoder[BaseSymbolInformation] =
    ...
    val decode_kind: Decoder[enumerations.SymbolKind] =
      enumerations.SymbolKind.fromJson
    val decode_tags: Decoder[Vector[enumerations.SymbolTag]] =
  ...
  given toJson: Encoder[BaseSymbolInformation] =
    ...
    val encode_kind: Encoder[enumerations.SymbolKind] =
      enumerations.SymbolKind.toJson
    val encode_tags: Encoder[Vector[enumerations.SymbolTag]] =
...
end structures_BaseSymbolInformationCodec
...
end structures_CallHierarchyClientCapabilitiesCodec

private[lsp] trait structures_CallHierarchyIncomingCallCodec:
  import structures.*
  given fromJson: Decoder[CallHierarchyIncomingCall] =
    // cache all decoders for this type when fromJson first initialised
    val decode_from: Decoder[structures.CallHierarchyItem] =
      structures.CallHierarchyItem.fromJson
    val decode_fromRanges: Decoder[Vector[structures.Range]] =
  ...
  given toJson: Encoder[CallHierarchyIncomingCall] =
    // cache all encoders for this type when toJson first initialised
    val encode_from: Encoder[structures.CallHierarchyItem] =
      structures.CallHierarchyItem.toJson
    val encode_fromRanges: Encoder[Vector[structures.Range]] =
...
end structures_CallHierarchyIncomingCallCodec
...
private[lsp] trait structures_CallHierarchyIncomingCallsParamsCodec:
  ...
  given toJson: Encoder[CallHierarchyIncomingCallsParams] =
    // cache all encoders for this type when toJson first initialised
    val encode_item: Encoder[structures.CallHierarchyItem] =
      structures.CallHierarchyItem.toJson
    val encode_workDoneToken: Encoder[aliases.ProgressToken] =
      aliases.ProgressToken.toJson
    val encode_partialResultToken: Encoder[aliases.ProgressToken] =
      aliases.ProgressToken.toJson
    Enc.toJsonObject: (enc, a) =>
...
end structures_CallHierarchyIncomingCallsParamsCodec
...
private[lsp] trait structures_CallHierarchyItemCodec:
  ...
  given fromJson: Decoder[CallHierarchyItem] =
    ...
    val decode_range: Decoder[structures.Range]  = structures.Range.fromJson
    val decode_selectionRange: Decoder[structures.Range] =
  ...
  given toJson: Encoder[CallHierarchyItem] =
    ...
    val encode_range: Encoder[structures.Range]  = structures.Range.toJson
    val encode_selectionRange: Encoder[structures.Range] =
...
end structures_CallHierarchyItemCodec
...
private[lsp] trait structures_CallHierarchyOutgoingCallCodec:
  ...
  given toJson: Encoder[CallHierarchyOutgoingCall] =
    // cache all encoders for this type when toJson first initialised
    val encode_to: Encoder[structures.CallHierarchyItem] =
      structures.CallHierarchyItem.toJson
    val encode_fromRanges: Encoder[Vector[structures.Range]] =
      Encoder.encodeVector(structures.Range.toJson)
    Enc.toJsonObject: (enc, a) =>
      ...
      enc.field("fromRanges", a.fromRanges, encode_fromRanges)
end structures_CallHierarchyOutgoingCallCodec
...
end structures_CallHierarchyOutgoingCallsParamsCodec
...
end structures_CallHierarchyPrepareParamsCodec
  ...
  given fromJson: Decoder[ChangeAnnotation] =
    ...
    Dec.fromJsonObject: dec =>
      for
        ...
        needsConfirmation <- dec.getOpt(
          "needsConfirmation",
          decode_needsConfirmation
        )
...
private[lsp] trait structures_ClientCapabilitiesCodec:
  ...
  given fromJson: Decoder[ClientCapabilities] =
    // cache all decoders for this type when fromJson first initialised
    val decode_workspace: Decoder[structures.WorkspaceClientCapabilities] =
      structures.WorkspaceClientCapabilities.fromJson
    val decode_textDocument
        : Decoder[structures.TextDocumentClientCapabilities] =
      structures.TextDocumentClientCapabilities.fromJson
    val decode_notebookDocument
        : Decoder[structures.NotebookDocumentClientCapabilities] =
      structures.NotebookDocumentClientCapabilities.fromJson
    val decode_window: Decoder[structures.WindowClientCapabilities] =
      structures.WindowClientCapabilities.fromJson
    val decode_general: Decoder[structures.GeneralClientCapabilities] =
      structures.GeneralClientCapabilities.fromJson
    ...
    Dec.fromJsonObject: dec =>
      for
        ...
        notebookDocument <- dec.getOpt(
          "notebookDocument",
          decode_notebookDocument
        )
  ...
  given toJson: Encoder[ClientCapabilities] =
    // cache all encoders for this type when toJson first initialised
    val encode_workspace: Encoder[structures.WorkspaceClientCapabilities] =
      structures.WorkspaceClientCapabilities.toJson
    val encode_textDocument
        : Encoder[structures.TextDocumentClientCapabilities] =
      structures.TextDocumentClientCapabilities.toJson
    val encode_notebookDocument
        : Encoder[structures.NotebookDocumentClientCapabilities] =
      structures.NotebookDocumentClientCapabilities.toJson
    val encode_window: Encoder[structures.WindowClientCapabilities] =
      structures.WindowClientCapabilities.toJson
    val encode_general: Encoder[structures.GeneralClientCapabilities] =
      structures.GeneralClientCapabilities.toJson
  ...
  given fromJson: Decoder[CodeActionClientCapabilities] =
    ...
    Dec.fromJsonObject: dec =>
      for
        ...
        codeActionLiteralSupport <- dec.getOpt(
          "codeActionLiteralSupport",
          decode_codeActionLiteralSupport
        )
        isPreferredSupport <- dec.getOpt(
          "isPreferredSupport",
          decode_isPreferredSupport
        )
        disabledSupport <- dec.getOpt("disabledSupport", decode_disabledSupport)
        dataSupport     <- dec.getOpt("dataSupport", decode_dataSupport)
        resolveSupport  <- dec.getOpt("resolveSupport", decode_resolveSupport)
        honorsChangeAnnotations <- dec.getOpt(
    ...
    Enc.toJsonObject: (enc, a) =>
      ...
      a.codeActionLiteralSupport.foreach: v =>
        enc.field(
          "codeActionLiteralSupport",
          v,
          encode_codeActionLiteralSupport
        )
...
private[lsp] trait structures_CodeActionContextCodec:
  ...
  given fromJson: Decoder[CodeActionContext] =
    ...
    val decode_diagnostics: Decoder[Vector[structures.Diagnostic]] =
      Decoder.decodeVector(structures.Diagnostic.fromJson)
    val decode_only: Decoder[Vector[enumerations.CodeActionKind]] =
      Decoder.decodeVector(enumerations.CodeActionKind.fromJson)
    val decode_triggerKind: Decoder[enumerations.CodeActionTriggerKind] =
      enumerations.CodeActionTriggerKind.fromJson
    Dec.fromJsonObject: dec =>
      for
  ...
  given toJson: Encoder[CodeActionContext] =
    ...
    val encode_diagnostics: Encoder[Vector[structures.Diagnostic]] =
      Encoder.encodeVector(structures.Diagnostic.toJson)
    val encode_only: Encoder[Vector[enumerations.CodeActionKind]] =
      Encoder.encodeVector(enumerations.CodeActionKind.toJson)
    val encode_triggerKind: Encoder[enumerations.CodeActionTriggerKind] =
      enumerations.CodeActionTriggerKind.toJson
    Enc.toJsonObject: (enc, a) =>
...
end structures_CodeActionOptionsCodec
...
private[lsp] trait structures_CodeActionParamsCodec:
  ...
  given fromJson: Decoder[CodeActionParams] =
    ...
    val decode_textDocument: Decoder[structures.TextDocumentIdentifier] =
      structures.TextDocumentIdentifier.fromJson
    val decode_range: Decoder[structures.Range] = structures.Range.fromJson
    val decode_context: Decoder[structures.CodeActionContext] =
      structures.CodeActionContext.fromJson
    val decode_workDoneToken: Decoder[aliases.ProgressToken] =
      aliases.ProgressToken.fromJson
    val decode_partialResultToken: Decoder[aliases.ProgressToken] =
      aliases.ProgressToken.fromJson
  ...
  given toJson: Encoder[CodeActionParams] =
    ...
    val encode_textDocument: Encoder[structures.TextDocumentIdentifier] =
      structures.TextDocumentIdentifier.toJson
    val encode_range: Encoder[structures.Range] = structures.Range.toJson
    val encode_context: Encoder[structures.CodeActionContext] =
      structures.CodeActionContext.toJson
    val encode_workDoneToken: Encoder[aliases.ProgressToken] =
      aliases.ProgressToken.toJson
    val encode_partialResultToken: Encoder[aliases.ProgressToken] =
      aliases.ProgressToken.toJson
...
end structures_CodeActionParamsCodec
...
private[lsp] trait structures_CodeDescriptionCodec:
  ...
  given fromJson: Decoder[CodeDescription] =
    ...
    Dec.fromJsonObject: dec =>
      for href <- dec.get("href", decode_href)
...
end structures_CodeDescriptionCodec
...
private[lsp] trait structures_CodeLensOptionsCodec:
  ...
  given toJson: Encoder[CodeLensOptions] =
    ...
    Enc.toJsonObject: (enc, a) =>
      ...
      a.workDoneProgress.foreach: v =>
        enc.field("workDoneProgress", v, encode_workDoneProgress)
end structures_CodeLensOptionsCodec
...
end structures_CodeLensParamsCodec
...
end structures_CodeLensRegistrationOptionsCodec
...
end structures_CodeLensWorkspaceClientCapabilitiesCodec
...
end structures_ColorInformationCodec
...
private[lsp] trait structures_ColorPresentationCodec:
  ...
  given fromJson: Decoder[ColorPresentation] =
    // cache all decoders for this type when fromJson first initialised
    val decode_label: Decoder[String]                 = Decoder.decodeString
    val decode_textEdit: Decoder[structures.TextEdit] =
      structures.TextEdit.fromJson
    val decode_additionalTextEdits: Decoder[Vector[structures.TextEdit]] =
      Decoder.decodeVector(structures.TextEdit.fromJson)
    Dec.fromJsonObject: dec =>
      for
        label               <- dec.get("label", decode_label)
        textEdit            <- dec.getOpt("textEdit", decode_textEdit)
        additionalTextEdits <- dec.getOpt(
          "additionalTextEdits",
          decode_additionalTextEdits
        )
  ...
  given toJson: Encoder[ColorPresentation] =
    // cache all encoders for this type when toJson first initialised
    val encode_label: Encoder[String]                 = Encoder.encodeString
    val encode_textEdit: Encoder[structures.TextEdit] =
      structures.TextEdit.toJson
    val encode_additionalTextEdits: Encoder[Vector[structures.TextEdit]] =
      Encoder.encodeVector(structures.TextEdit.toJson)
    Enc.toJsonObject: (enc, a) =>
      enc.field("label", a.label, encode_label)
...
end structures_ColorPresentationCodec
...
end structures_ColorPresentationParamsCodec
  ...
  given fromJson: Decoder[CompletionClientCapabilities] =
    ...
    Dec.fromJsonObject: dec =>
      for
        ...
        completionItemKind <- dec.getOpt(
          "completionItemKind",
          decode_completionItemKind
        )
...
private[lsp] trait structures_CompletionContextCodec:
  ...
  given fromJson: Decoder[CompletionContext] =
    // cache all decoders for this type when fromJson first initialised
    val decode_triggerKind: Decoder[enumerations.CompletionTriggerKind] =
      enumerations.CompletionTriggerKind.fromJson
    val decode_triggerCharacter: Decoder[String] = Decoder.decodeString
    Dec.fromJsonObject: dec =>
      for
        triggerKind      <- dec.get("triggerKind", decode_triggerKind)
        triggerCharacter <- dec.getOpt(
          "triggerCharacter",
          decode_triggerCharacter
        )
  ...
  given toJson: Encoder[CompletionContext] =
    // cache all encoders for this type when toJson first initialised
    val encode_triggerKind: Encoder[enumerations.CompletionTriggerKind] =
      enumerations.CompletionTriggerKind.toJson
...
end structures_CompletionContextCodec
...
private[lsp] trait structures_CompletionItemCodec:
  ...
  given fromJson: Decoder[CompletionItem] =
    // cache all decoders for this type when fromJson first initialised
    val decode_label: Decoder[String] = Decoder.decodeString
    val decode_labelDetails: Decoder[structures.CompletionItemLabelDetails] =
      structures.CompletionItemLabelDetails.fromJson
    val decode_kind: Decoder[enumerations.CompletionItemKind] =
      enumerations.CompletionItemKind.fromJson
    val decode_tags: Decoder[Vector[enumerations.CompletionItemTag]] =
      Decoder.decodeVector(enumerations.CompletionItemTag.fromJson)
    val decode_detail: Decoder[String] = Decoder.decodeString
    val decode_documentation: Decoder[(String | structures.MarkupContent)] =
    ...
    val decode_insertTextMode: Decoder[enumerations.InsertTextMode] =
      enumerations.InsertTextMode.fromJson
    val decode_textEdit
        : Decoder[(structures.TextEdit | structures.InsertReplaceEdit)] =
      Dec.union2[structures.TextEdit, structures.InsertReplaceEdit](
        structures.TextEdit.fromJson,
        structures.InsertReplaceEdit.fromJson
      )
  ...
  given toJson: Encoder[CompletionItem] =
    // cache all encoders for this type when toJson first initialised
    val encode_label: Encoder[String] = Encoder.encodeString
    val encode_labelDetails: Encoder[structures.CompletionItemLabelDetails] =
      structures.CompletionItemLabelDetails.toJson
    val encode_kind: Encoder[enumerations.CompletionItemKind] =
      enumerations.CompletionItemKind.toJson
    val encode_tags: Encoder[Vector[enumerations.CompletionItemTag]] =
      Encoder.encodeVector(enumerations.CompletionItemTag.toJson)
    val encode_detail: Encoder[String] = Encoder.encodeString
    val encode_documentation: Encoder[(String | structures.MarkupContent)] =
    ...
    val encode_insertTextMode: Encoder[enumerations.InsertTextMode] =
      enumerations.InsertTextMode.toJson
    val encode_textEdit
        : Encoder[(structures.TextEdit | structures.InsertReplaceEdit)] =
      Enc.union2[structures.TextEdit, structures.InsertReplaceEdit](
        structures.TextEdit.toJson,
        structures.InsertReplaceEdit.toJson
      )
...
private[lsp] trait structures_CompletionOptionsCodec:
  ...
  given fromJson: Decoder[CompletionOptions] =
    // cache all decoders for this type when fromJson first initialised
    val decode_triggerCharacters: Decoder[Vector[String]] =
      Decoder.decodeVector(Decoder.decodeString)
    ...
    Dec.fromJsonObject: dec =>
      for
        triggerCharacters <- dec.getOpt(
          "triggerCharacters",
          decode_triggerCharacters
        )
        allCommitCharacters <- dec.getOpt(
          "allCommitCharacters",
          decode_allCommitCharacters
        )
        resolveProvider <- dec.getOpt("resolveProvider", decode_resolveProvider)
        completionItem  <- dec.getOpt("completionItem", decode_completionItem)
        workDoneProgress <- dec.getOpt(
  ...
  given toJson: Encoder[CompletionOptions] =
    // cache all encoders for this type when toJson first initialised
    val encode_triggerCharacters: Encoder[Vector[String]] =
      Encoder.encodeVector(Encoder.encodeString)
...
private[lsp] trait structures_CompletionParamsCodec:
  ...
  given fromJson: Decoder[CompletionParams] =
    // cache all decoders for this type when fromJson first initialised
    val decode_context: Decoder[structures.CompletionContext] =
      structures.CompletionContext.fromJson
    val decode_textDocument: Decoder[structures.TextDocumentIdentifier] =
      structures.TextDocumentIdentifier.fromJson
    val decode_position: Decoder[structures.Position] =
      structures.Position.fromJson
  ...
  given toJson: Encoder[CompletionParams] =
    // cache all encoders for this type when toJson first initialised
    val encode_context: Encoder[structures.CompletionContext] =
      structures.CompletionContext.toJson
    val encode_textDocument: Encoder[structures.TextDocumentIdentifier] =
      structures.TextDocumentIdentifier.toJson
    val encode_position: Encoder[structures.Position] =
      structures.Position.toJson
...
end structures_CompletionParamsCodec
...
end structures_ConfigurationItemCodec

private[lsp] trait structures_ConfigurationParamsCodec:
  import structures.*
  given fromJson: Decoder[ConfigurationParams] =
    // cache all decoders for this type when fromJson first initialised
    val decode_items: Decoder[Vector[structures.ConfigurationItem]] =
      Decoder.decodeVector(structures.ConfigurationItem.fromJson)
    Dec.fromJsonObject: dec =>
  ...
  given toJson: Encoder[ConfigurationParams] =
    // cache all encoders for this type when toJson first initialised
    val encode_items: Encoder[Vector[structures.ConfigurationItem]] =
      Encoder.encodeVector(structures.ConfigurationItem.toJson)
    Enc.toJsonObject: (enc, a) =>
      enc.field("items", a.items, encode_items)
end structures_ConfigurationParamsCodec
...
private[lsp] trait structures_CreateFileCodec:
  ...
  given fromJson: Decoder[CreateFile] =
    ...
    val decode_uri: Decoder[runtime.DocumentUri] = DocumentUri.fromJson
    val decode_options: Decoder[structures.CreateFileOptions] =
      structures.CreateFileOptions.fromJson
    val decode_annotationId: Decoder[aliases.ChangeAnnotationIdentifier] =
      aliases.ChangeAnnotationIdentifier.fromJson
    Dec.fromJsonObject: dec =>
      for
  ...
  given toJson: Encoder[CreateFile] =
    ...
    val encode_uri: Encoder[runtime.DocumentUri] = DocumentUri.toJson
    val encode_options: Encoder[structures.CreateFileOptions] =
      structures.CreateFileOptions.toJson
    val encode_annotationId: Encoder[aliases.ChangeAnnotationIdentifier] =
      aliases.ChangeAnnotationIdentifier.toJson
    Enc.toJsonObject: (enc, a) =>
      enc.field("kind", a.kind, encode_kind)
...
end structures_CreateFileCodec
...
end structures_CreateFileOptionsCodec

private[lsp] trait structures_CreateFilesParamsCodec:
  import structures.*
  given fromJson: Decoder[CreateFilesParams] =
    // cache all decoders for this type when fromJson first initialised
    val decode_files: Decoder[Vector[structures.FileCreate]] =
      Decoder.decodeVector(structures.FileCreate.fromJson)
    Dec.fromJsonObject: dec =>
      for files <- dec.get("files", decode_files)
      yield CreateFilesParams(
        files
      )
  given toJson: Encoder[CreateFilesParams] =
    // cache all encoders for this type when toJson first initialised
    val encode_files: Encoder[Vector[structures.FileCreate]] =
      Encoder.encodeVector(structures.FileCreate.toJson)
    Enc.toJsonObject: (enc, a) =>
      enc.field("files", a.files, encode_files)
end structures_CreateFilesParamsCodec
...
end structures_DeclarationClientCapabilitiesCodec
...
private[lsp] trait structures_DeclarationOptionsCodec:
  ...
  given toJson: Encoder[DeclarationOptions] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.workDoneProgress.foreach: v =>
        enc.field("workDoneProgress", v, encode_workDoneProgress)
end structures_DeclarationOptionsCodec
...
end structures_DeclarationParamsCodec
...
end structures_DeclarationRegistrationOptionsCodec
...
private[lsp] trait structures_DefinitionClientCapabilitiesCodec:
  ...
  given toJson: Encoder[DefinitionClientCapabilities] =
    ...
    Enc.toJsonObject: (enc, a) =>
      ...
      a.linkSupport.foreach: v =>
        enc.field("linkSupport", v, encode_linkSupport)
end structures_DefinitionClientCapabilitiesCodec
...
private[lsp] trait structures_DefinitionOptionsCodec:
  ...
  given toJson: Encoder[DefinitionOptions] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.workDoneProgress.foreach: v =>
        enc.field("workDoneProgress", v, encode_workDoneProgress)
end structures_DefinitionOptionsCodec
...
end structures_DefinitionParamsCodec
...
private[lsp] trait structures_DefinitionRegistrationOptionsCodec:
  ...
  given toJson: Encoder[DefinitionRegistrationOptions] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.documentSelector.foreach: v =>
        enc.field("documentSelector", v, encode_documentSelector)
end structures_DefinitionRegistrationOptionsCodec
...
private[lsp] trait structures_DeleteFileCodec:
  ...
  given fromJson: Decoder[DeleteFile] =
    ...
    val decode_uri: Decoder[runtime.DocumentUri] = DocumentUri.fromJson
    val decode_options: Decoder[structures.DeleteFileOptions] =
      structures.DeleteFileOptions.fromJson
    val decode_annotationId: Decoder[aliases.ChangeAnnotationIdentifier] =
      aliases.ChangeAnnotationIdentifier.fromJson
    Dec.fromJsonObject: dec =>
      for
  ...
  given toJson: Encoder[DeleteFile] =
    ...
    val encode_uri: Encoder[runtime.DocumentUri] = DocumentUri.toJson
    val encode_options: Encoder[structures.DeleteFileOptions] =
      structures.DeleteFileOptions.toJson
    val encode_annotationId: Encoder[aliases.ChangeAnnotationIdentifier] =
      aliases.ChangeAnnotationIdentifier.toJson
    Enc.toJsonObject: (enc, a) =>
      enc.field("kind", a.kind, encode_kind)
...
end structures_DeleteFileCodec
  ...
  given fromJson: Decoder[DeleteFileOptions] =
    ...
    Dec.fromJsonObject: dec =>
      for
        ...
        ignoreIfNotExists <- dec.getOpt(
          "ignoreIfNotExists",
          decode_ignoreIfNotExists
        )
...
end structures_DeleteFileOptionsCodec

private[lsp] trait structures_DeleteFilesParamsCodec:
  import structures.*
  given fromJson: Decoder[DeleteFilesParams] =
    // cache all decoders for this type when fromJson first initialised
    val decode_files: Decoder[Vector[structures.FileDelete]] =
      Decoder.decodeVector(structures.FileDelete.fromJson)
    Dec.fromJsonObject: dec =>
      for files <- dec.get("files", decode_files)
  ...
  given toJson: Encoder[DeleteFilesParams] =
    // cache all encoders for this type when toJson first initialised
    val encode_files: Encoder[Vector[structures.FileDelete]] =
      Encoder.encodeVector(structures.FileDelete.toJson)
    Enc.toJsonObject: (enc, a) =>
      enc.field("files", a.files, encode_files)
end structures_DeleteFilesParamsCodec
...
private[lsp] trait structures_DiagnosticCodec:
  ...
  given fromJson: Decoder[Diagnostic] =
    // cache all decoders for this type when fromJson first initialised
    val decode_range: Decoder[structures.Range] = structures.Range.fromJson
    val decode_severity: Decoder[enumerations.DiagnosticSeverity] =
      enumerations.DiagnosticSeverity.fromJson
    val decode_code: Decoder[(Int | String)] =
      Dec.union2[Int, String](Decoder.decodeInt, Decoder.decodeString)
    ...
    val decode_relatedInformation
        : Decoder[Vector[structures.DiagnosticRelatedInformation]] =
      Decoder.decodeVector(structures.DiagnosticRelatedInformation.fromJson)
    val decode_data: Decoder[io.circe.Json] = Decoder.decodeJson
    Dec.fromJsonObject: dec =>
      for
        range           <- dec.get("range", decode_range)
  ...
  given toJson: Encoder[Diagnostic] =
    // cache all encoders for this type when toJson first initialised
    val encode_range: Encoder[structures.Range] = structures.Range.toJson
    val encode_severity: Encoder[enumerations.DiagnosticSeverity] =
      enumerations.DiagnosticSeverity.toJson
    val encode_code: Encoder[(Int | String)] =
      Enc.union2[Int, String](Encoder.encodeInt, Encoder.encodeString)
    ...
    val encode_relatedInformation
        : Encoder[Vector[structures.DiagnosticRelatedInformation]] =
      Encoder.encodeVector(structures.DiagnosticRelatedInformation.toJson)
    val encode_data: Encoder[io.circe.Json] = Encoder.encodeJson
    Enc.toJsonObject: (enc, a) =>
      enc.field("range", a.range, encode_range)
...
end structures_DiagnosticCodec
  ...
  given fromJson: Decoder[DiagnosticClientCapabilities] =
    ...
    Dec.fromJsonObject: dec =>
      for
        ...
        relatedDocumentSupport <- dec.getOpt(
...
private[lsp] trait structures_DiagnosticOptionsCodec:
  ...
  given fromJson: Decoder[DiagnosticOptions] =
    ...
    Dec.fromJsonObject: dec =>
      for
        ...
        interFileDependencies <- dec.get(
          "interFileDependencies",
          decode_interFileDependencies
        )
        workspaceDiagnostics <- dec.get(
          "workspaceDiagnostics",
          decode_workspaceDiagnostics
        )
        workDoneProgress <- dec.getOpt(
          "workDoneProgress",
          decode_workDoneProgress
  ...
  given toJson: Encoder[DiagnosticOptions] =
    ...
    Enc.toJsonObject: (enc, a) =>
      ...
      enc.field(
        "interFileDependencies",
        a.interFileDependencies,
        encode_interFileDependencies
      )
      enc.field(
        "workspaceDiagnostics",
        a.workspaceDiagnostics,
        encode_workspaceDiagnostics
      )
      a.workDoneProgress.foreach: v =>
        enc.field("workDoneProgress", v, encode_workDoneProgress)
  end toJson
end structures_DiagnosticOptionsCodec
...
private[lsp] trait structures_DiagnosticRelatedInformationCodec:
  ...
  given toJson: Encoder[DiagnosticRelatedInformation] =
    // cache all encoders for this type when toJson first initialised
    val encode_location: Encoder[structures.Location] =
    ...
    Enc.toJsonObject: (enc, a) =>
      ...
      enc.field("message", a.message, encode_message)
end structures_DiagnosticRelatedInformationCodec
...
private[lsp] trait structures_DiagnosticServerCancellationDataCodec:
  ...
  given fromJson: Decoder[DiagnosticServerCancellationData] =
    ...
    Dec.fromJsonObject: dec =>
      for retriggerRequest <- dec.get(
          "retriggerRequest",
          decode_retriggerRequest
        )
...
end structures_DiagnosticServerCancellationDataCodec
...
private[lsp] trait structures_DidChangeConfigurationClientCapabilitiesCodec:
  ...
  given toJson: Encoder[DidChangeConfigurationClientCapabilities] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.dynamicRegistration.foreach: v =>
        enc.field("dynamicRegistration", v, encode_dynamicRegistration)
end structures_DidChangeConfigurationClientCapabilitiesCodec
...
private[lsp] trait structures_DidChangeConfigurationParamsCodec:
  ...
  given fromJson: Decoder[DidChangeConfigurationParams] =
    ...
    Dec.fromJsonObject: dec =>
      for settings <- dec.get("settings", decode_settings)
...
end structures_DidChangeConfigurationParamsCodec
...
private[lsp] trait structures_DidChangeConfigurationRegistrationOptionsCodec:
  ...
  given fromJson: Decoder[DidChangeConfigurationRegistrationOptions] =
    // cache all decoders for this type when fromJson first initialised
    val decode_section: Decoder[(String | Vector[String])] =
      Dec.union2[String, Vector[String]](
        Decoder.decodeString,
        Decoder.decodeVector(Decoder.decodeString)
      )
    Dec.fromJsonObject: dec =>
      for section <- dec.getOpt("section", decode_section)
  ...
  given toJson: Encoder[DidChangeConfigurationRegistrationOptions] =
    // cache all encoders for this type when toJson first initialised
    val encode_section: Encoder[(String | Vector[String])] =
      Enc.union2[String, Vector[String]](
        Encoder.encodeString,
        Encoder.encodeVector(Encoder.encodeString)
      )
    Enc.toJsonObject: (enc, a) =>
...
end structures_DidChangeConfigurationRegistrationOptionsCodec
...
private[lsp] trait structures_DidChangeNotebookDocumentParamsCodec:
  ...
  given fromJson: Decoder[DidChangeNotebookDocumentParams] =
    // cache all decoders for this type when fromJson first initialised
    val decode_notebookDocument
        : Decoder[structures.VersionedNotebookDocumentIdentifier] =
      structures.VersionedNotebookDocumentIdentifier.fromJson
    val decode_change: Decoder[structures.NotebookDocumentChangeEvent] =
      structures.NotebookDocumentChangeEvent.fromJson
    Dec.fromJsonObject: dec =>
      for
  ...
  given toJson: Encoder[DidChangeNotebookDocumentParams] =
    // cache all encoders for this type when toJson first initialised
    val encode_notebookDocument
        : Encoder[structures.VersionedNotebookDocumentIdentifier] =
      structures.VersionedNotebookDocumentIdentifier.toJson
    val encode_change: Encoder[structures.NotebookDocumentChangeEvent] =
      structures.NotebookDocumentChangeEvent.toJson
    Enc.toJsonObject: (enc, a) =>
      enc.field("notebookDocument", a.notebookDocument, encode_notebookDocument)
      enc.field("change", a.change, encode_change)
  end toJson
end structures_DidChangeNotebookDocumentParamsCodec
...
private[lsp] trait structures_DidChangeTextDocumentParamsCodec:
  ...
  given fromJson: Decoder[DidChangeTextDocumentParams] =
    // cache all decoders for this type when fromJson first initialised
    val decode_textDocument
        : Decoder[structures.VersionedTextDocumentIdentifier] =
      structures.VersionedTextDocumentIdentifier.fromJson
    val decode_contentChanges
        : Decoder[Vector[aliases.TextDocumentContentChangeEvent]] =
      Decoder.decodeVector(aliases.TextDocumentContentChangeEvent.fromJson)
    Dec.fromJsonObject: dec =>
      for
        textDocument   <- dec.get("textDocument", decode_textDocument)
  ...
  given toJson: Encoder[DidChangeTextDocumentParams] =
    // cache all encoders for this type when toJson first initialised
    val encode_textDocument
        : Encoder[structures.VersionedTextDocumentIdentifier] =
      structures.VersionedTextDocumentIdentifier.toJson
    val encode_contentChanges
        : Encoder[Vector[aliases.TextDocumentContentChangeEvent]] =
      Encoder.encodeVector(aliases.TextDocumentContentChangeEvent.toJson)
    Enc.toJsonObject: (enc, a) =>
      enc.field("textDocument", a.textDocument, encode_textDocument)
      enc.field("contentChanges", a.contentChanges, encode_contentChanges)
  end toJson
end structures_DidChangeTextDocumentParamsCodec
  ...
  given fromJson: Decoder[DidChangeWatchedFilesClientCapabilities] =
    ...
    Dec.fromJsonObject: dec =>
      for
        ...
        relativePatternSupport <- dec.getOpt(
...
end structures_DidChangeWatchedFilesClientCapabilitiesCodec

private[lsp] trait structures_DidChangeWatchedFilesParamsCodec:
  import structures.*
  given fromJson: Decoder[DidChangeWatchedFilesParams] =
    // cache all decoders for this type when fromJson first initialised
    val decode_changes: Decoder[Vector[structures.FileEvent]] =
      Decoder.decodeVector(structures.FileEvent.fromJson)
    Dec.fromJsonObject: dec =>
      for changes <- dec.get("changes", decode_changes)
      yield DidChangeWatchedFilesParams(
        changes
      )
  given toJson: Encoder[DidChangeWatchedFilesParams] =
    // cache all encoders for this type when toJson first initialised
    val encode_changes: Encoder[Vector[structures.FileEvent]] =
      Encoder.encodeVector(structures.FileEvent.toJson)
    Enc.toJsonObject: (enc, a) =>
      enc.field("changes", a.changes, encode_changes)
end structures_DidChangeWatchedFilesParamsCodec
...
private[lsp] trait structures_DidChangeWatchedFilesRegistrationOptionsCodec:
  ...
  given fromJson: Decoder[DidChangeWatchedFilesRegistrationOptions] =
    // cache all decoders for this type when fromJson first initialised
    val decode_watchers: Decoder[Vector[structures.FileSystemWatcher]] =
      Decoder.decodeVector(structures.FileSystemWatcher.fromJson)
    Dec.fromJsonObject: dec =>
      for watchers <- dec.get("watchers", decode_watchers)
      yield DidChangeWatchedFilesRegistrationOptions(
        watchers
      )
  given toJson: Encoder[DidChangeWatchedFilesRegistrationOptions] =
    // cache all encoders for this type when toJson first initialised
    val encode_watchers: Encoder[Vector[structures.FileSystemWatcher]] =
      Encoder.encodeVector(structures.FileSystemWatcher.toJson)
    Enc.toJsonObject: (enc, a) =>
      enc.field("watchers", a.watchers, encode_watchers)
end structures_DidChangeWatchedFilesRegistrationOptionsCodec

private[lsp] trait structures_DidChangeWorkspaceFoldersParamsCodec:
  import structures.*
  given fromJson: Decoder[DidChangeWorkspaceFoldersParams] =
    // cache all decoders for this type when fromJson first initialised
    val decode_event: Decoder[structures.WorkspaceFoldersChangeEvent] =
      structures.WorkspaceFoldersChangeEvent.fromJson
    Dec.fromJsonObject: dec =>
      for event <- dec.get("event", decode_event)
      yield DidChangeWorkspaceFoldersParams(
        event
      )
  given toJson: Encoder[DidChangeWorkspaceFoldersParams] =
    // cache all encoders for this type when toJson first initialised
    val encode_event: Encoder[structures.WorkspaceFoldersChangeEvent] =
      structures.WorkspaceFoldersChangeEvent.toJson
    Enc.toJsonObject: (enc, a) =>
      enc.field("event", a.event, encode_event)
end structures_DidChangeWorkspaceFoldersParamsCodec
...
private[lsp] trait structures_DidCloseNotebookDocumentParamsCodec:
  ...
  given fromJson: Decoder[DidCloseNotebookDocumentParams] =
    // cache all decoders for this type when fromJson first initialised
    val decode_notebookDocument
        : Decoder[structures.NotebookDocumentIdentifier] =
      structures.NotebookDocumentIdentifier.fromJson
    val decode_cellTextDocuments
        : Decoder[Vector[structures.TextDocumentIdentifier]] =
      Decoder.decodeVector(structures.TextDocumentIdentifier.fromJson)
    Dec.fromJsonObject: dec =>
      for
        notebookDocument <- dec.get("notebookDocument", decode_notebookDocument)
        cellTextDocuments <- dec.get(
          "cellTextDocuments",
          decode_cellTextDocuments
        )
  ...
  given toJson: Encoder[DidCloseNotebookDocumentParams] =
    // cache all encoders for this type when toJson first initialised
    val encode_notebookDocument
        : Encoder[structures.NotebookDocumentIdentifier] =
      structures.NotebookDocumentIdentifier.toJson
    val encode_cellTextDocuments
        : Encoder[Vector[structures.TextDocumentIdentifier]] =
      Encoder.encodeVector(structures.TextDocumentIdentifier.toJson)
    Enc.toJsonObject: (enc, a) =>
      enc.field("notebookDocument", a.notebookDocument, encode_notebookDocument)
      enc.field(
        "cellTextDocuments",
        a.cellTextDocuments,
        encode_cellTextDocuments
      )
  end toJson
end structures_DidCloseNotebookDocumentParamsCodec
...
private[lsp] trait structures_DidCloseTextDocumentParamsCodec:
  ...
  given fromJson: Decoder[DidCloseTextDocumentParams] =
    ...
    val decode_textDocument: Decoder[structures.TextDocumentIdentifier] =
      structures.TextDocumentIdentifier.fromJson
    Dec.fromJsonObject: dec =>
      for textDocument <- dec.get("textDocument", decode_textDocument)
  ...
  given toJson: Encoder[DidCloseTextDocumentParams] =
    ...
    Enc.toJsonObject: (enc, a) =>
      enc.field("textDocument", a.textDocument, encode_textDocument)
end structures_DidCloseTextDocumentParamsCodec

private[lsp] trait structures_DidOpenNotebookDocumentParamsCodec:
  import structures.*
  given fromJson: Decoder[DidOpenNotebookDocumentParams] =
    // cache all decoders for this type when fromJson first initialised
    val decode_notebookDocument: Decoder[structures.NotebookDocument] =
      structures.NotebookDocument.fromJson
    val decode_cellTextDocuments: Decoder[Vector[structures.TextDocumentItem]] =
      Decoder.decodeVector(structures.TextDocumentItem.fromJson)
    Dec.fromJsonObject: dec =>
      for
        notebookDocument <- dec.get("notebookDocument", decode_notebookDocument)
        cellTextDocuments <- dec.get(
  ...
  given toJson: Encoder[DidOpenNotebookDocumentParams] =
    // cache all encoders for this type when toJson first initialised
    val encode_notebookDocument: Encoder[structures.NotebookDocument] =
      structures.NotebookDocument.toJson
    val encode_cellTextDocuments: Encoder[Vector[structures.TextDocumentItem]] =
      Encoder.encodeVector(structures.TextDocumentItem.toJson)
    Enc.toJsonObject: (enc, a) =>
      enc.field("notebookDocument", a.notebookDocument, encode_notebookDocument)
      enc.field(
        "cellTextDocuments",
...
end structures_DidOpenNotebookDocumentParamsCodec

private[lsp] trait structures_DidOpenTextDocumentParamsCodec:
  import structures.*
  given fromJson: Decoder[DidOpenTextDocumentParams] =
    // cache all decoders for this type when fromJson first initialised
    val decode_textDocument: Decoder[structures.TextDocumentItem] =
      structures.TextDocumentItem.fromJson
    Dec.fromJsonObject: dec =>
      for textDocument <- dec.get("textDocument", decode_textDocument)
  ...
  given toJson: Encoder[DidOpenTextDocumentParams] =
    // cache all encoders for this type when toJson first initialised
    val encode_textDocument: Encoder[structures.TextDocumentItem] =
      structures.TextDocumentItem.toJson
    Enc.toJsonObject: (enc, a) =>
      enc.field("textDocument", a.textDocument, encode_textDocument)
end structures_DidOpenTextDocumentParamsCodec
...
private[lsp] trait structures_DidSaveNotebookDocumentParamsCodec:
  ...
  given toJson: Encoder[DidSaveNotebookDocumentParams] =
    ...
    Enc.toJsonObject: (enc, a) =>
      enc.field("notebookDocument", a.notebookDocument, encode_notebookDocument)
end structures_DidSaveNotebookDocumentParamsCodec
...
end structures_DidSaveTextDocumentParamsCodec
...
private[lsp] trait structures_DocumentColorClientCapabilitiesCodec:
  ...
  given toJson: Encoder[DocumentColorClientCapabilities] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.dynamicRegistration.foreach: v =>
        enc.field("dynamicRegistration", v, encode_dynamicRegistration)
end structures_DocumentColorClientCapabilitiesCodec
...
private[lsp] trait structures_DocumentColorOptionsCodec:
  ...
  given toJson: Encoder[DocumentColorOptions] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.workDoneProgress.foreach: v =>
        enc.field("workDoneProgress", v, encode_workDoneProgress)
end structures_DocumentColorOptionsCodec
...
end structures_DocumentColorParamsCodec
...
end structures_DocumentColorRegistrationOptionsCodec
  ...
  given fromJson: Decoder[DocumentDiagnosticParams] =
    ...
    Dec.fromJsonObject: dec =>
      for
        textDocument     <- dec.get("textDocument", decode_textDocument)
        identifier       <- dec.getOpt("identifier", decode_identifier)
        previousResultId <- dec.getOpt(
          "previousResultId",
          decode_previousResultId
        )
        workDoneToken      <- dec.getOpt("workDoneToken", decode_workDoneToken)
        partialResultToken <- dec.getOpt(
          "partialResultToken",
...
end structures_DocumentDiagnosticParamsCodec
...
private[lsp] trait structures_DocumentDiagnosticReportPartialResultCodec:
  ...
  given fromJson: Decoder[DocumentDiagnosticReportPartialResult] =
    // cache all decoders for this type when fromJson first initialised
    val decode_relatedDocuments: Decoder[Map[
      runtime.DocumentUri,
      (structures.FullDocumentDiagnosticReport |
        structures.UnchangedDocumentDiagnosticReport)
    ]] = Decoder.decodeMap(
      KeyDecoder.decodeKeyString.map(runtime.DocumentUri.apply),
      Dec.union2[
        structures.FullDocumentDiagnosticReport,
        structures.UnchangedDocumentDiagnosticReport
      ](
        structures.FullDocumentDiagnosticReport.fromJson,
        structures.UnchangedDocumentDiagnosticReport.fromJson
      )
    )
    Dec.fromJsonObject: dec =>
      for relatedDocuments <- dec.get(
          "relatedDocuments",
          decode_relatedDocuments
        )
  ...
  given toJson: Encoder[DocumentDiagnosticReportPartialResult] =
    // cache all encoders for this type when toJson first initialised
    val encode_relatedDocuments: Encoder[Map[
      runtime.DocumentUri,
      (structures.FullDocumentDiagnosticReport |
        structures.UnchangedDocumentDiagnosticReport)
    ]] = Encoder.encodeMap(
      ...
      Enc.union2[
        ...
        structures.FullDocumentDiagnosticReport.toJson,
        structures.UnchangedDocumentDiagnosticReport.toJson
      )
    )
    Enc.toJsonObject: (enc, a) =>
      enc.field("relatedDocuments", a.relatedDocuments, encode_relatedDocuments)
  end toJson
end structures_DocumentDiagnosticReportPartialResultCodec
...
private[lsp] trait structures_DocumentFormattingClientCapabilitiesCodec:
  ...
  given toJson: Encoder[DocumentFormattingClientCapabilities] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.dynamicRegistration.foreach: v =>
        enc.field("dynamicRegistration", v, encode_dynamicRegistration)
end structures_DocumentFormattingClientCapabilitiesCodec
...
private[lsp] trait structures_DocumentFormattingOptionsCodec:
  ...
  given toJson: Encoder[DocumentFormattingOptions] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.workDoneProgress.foreach: v =>
        enc.field("workDoneProgress", v, encode_workDoneProgress)
end structures_DocumentFormattingOptionsCodec
...
end structures_DocumentFormattingParamsCodec
...
private[lsp] trait structures_DocumentFormattingRegistrationOptionsCodec:
  ...
  given toJson: Encoder[DocumentFormattingRegistrationOptions] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.documentSelector.foreach: v =>
        enc.field("documentSelector", v, encode_documentSelector)
end structures_DocumentFormattingRegistrationOptionsCodec
...
private[lsp] trait structures_DocumentHighlightCodec:
  ...
  given fromJson: Decoder[DocumentHighlight] =
    // cache all decoders for this type when fromJson first initialised
    val decode_range: Decoder[structures.Range] = structures.Range.fromJson
    val decode_kind: Decoder[enumerations.DocumentHighlightKind] =
      enumerations.DocumentHighlightKind.fromJson
    Dec.fromJsonObject: dec =>
      for
        range <- dec.get("range", decode_range)
        kind  <- dec.getOpt("kind", decode_kind)
  ...
  given toJson: Encoder[DocumentHighlight] =
    // cache all encoders for this type when toJson first initialised
    val encode_range: Encoder[structures.Range] = structures.Range.toJson
    val encode_kind: Encoder[enumerations.DocumentHighlightKind] =
      enumerations.DocumentHighlightKind.toJson
    Enc.toJsonObject: (enc, a) =>
      enc.field("range", a.range, encode_range)
      a.kind.foreach: v =>
        enc.field("kind", v, encode_kind)
end structures_DocumentHighlightCodec
...
private[lsp] trait structures_DocumentHighlightClientCapabilitiesCodec:
  ...
  given toJson: Encoder[DocumentHighlightClientCapabilities] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.dynamicRegistration.foreach: v =>
        enc.field("dynamicRegistration", v, encode_dynamicRegistration)
end structures_DocumentHighlightClientCapabilitiesCodec
...
private[lsp] trait structures_DocumentHighlightOptionsCodec:
  ...
  given toJson: Encoder[DocumentHighlightOptions] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.workDoneProgress.foreach: v =>
        enc.field("workDoneProgress", v, encode_workDoneProgress)
end structures_DocumentHighlightOptionsCodec
...
end structures_DocumentHighlightParamsCodec
...
private[lsp] trait structures_DocumentHighlightRegistrationOptionsCodec:
  ...
  given toJson: Encoder[DocumentHighlightRegistrationOptions] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.documentSelector.foreach: v =>
        enc.field("documentSelector", v, encode_documentSelector)
end structures_DocumentHighlightRegistrationOptionsCodec
...
end structures_DocumentLinkCodec
...
end structures_DocumentLinkClientCapabilitiesCodec
...
private[lsp] trait structures_DocumentLinkOptionsCodec:
  ...
  given toJson: Encoder[DocumentLinkOptions] =
    ...
    Enc.toJsonObject: (enc, a) =>
      ...
      a.workDoneProgress.foreach: v =>
        enc.field("workDoneProgress", v, encode_workDoneProgress)
end structures_DocumentLinkOptionsCodec
...
end structures_DocumentLinkParamsCodec
...
end structures_DocumentLinkRegistrationOptionsCodec
...
private[lsp] trait structures_DocumentOnTypeFormattingClientCapabilitiesCodec:
  ...
  given toJson: Encoder[DocumentOnTypeFormattingClientCapabilities] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.dynamicRegistration.foreach: v =>
        enc.field("dynamicRegistration", v, encode_dynamicRegistration)
end structures_DocumentOnTypeFormattingClientCapabilitiesCodec
...
private[lsp] trait structures_DocumentOnTypeFormattingOptionsCodec:
  ...
  given fromJson: Decoder[DocumentOnTypeFormattingOptions] =
    ...
    val decode_moreTriggerCharacter: Decoder[Vector[String]] =
      Decoder.decodeVector(Decoder.decodeString)
    Dec.fromJsonObject: dec =>
      for
        firstTriggerCharacter <- dec.get(
          "firstTriggerCharacter",
          decode_firstTriggerCharacter
        )
        moreTriggerCharacter <- dec.getOpt(
          "moreTriggerCharacter",
          decode_moreTriggerCharacter
        )
  ...
  given toJson: Encoder[DocumentOnTypeFormattingOptions] =
    ...
    val encode_moreTriggerCharacter: Encoder[Vector[String]] =
      Encoder.encodeVector(Encoder.encodeString)
    Enc.toJsonObject: (enc, a) =>
      enc.field(
        "firstTriggerCharacter",
        a.firstTriggerCharacter,
        encode_firstTriggerCharacter
      )
      a.moreTriggerCharacter.foreach: v =>
        enc.field("moreTriggerCharacter", v, encode_moreTriggerCharacter)
  end toJson
end structures_DocumentOnTypeFormattingOptionsCodec
...
end structures_DocumentOnTypeFormattingParamsCodec
...
end structures_DocumentOnTypeFormattingRegistrationOptionsCodec
...
end structures_DocumentRangeFormattingParamsCodec
...
private[lsp] trait structures_DocumentSymbolCodec:
  ...
  given fromJson: Decoder[DocumentSymbol] =
    ...
    Decoder.recursive: decode_DocumentSymbol =>
      ...
      val decode_selectionRange: Decoder[structures.Range] =
        structures.Range.fromJson
      val decode_children: Decoder[Vector[structures.DocumentSymbol]] =
        Decoder.decodeVector(decode_DocumentSymbol)
      Dec.fromJsonObject: dec =>
        for
          name           <- dec.get("name", decode_name)
          detail         <- dec.getOpt("detail", decode_detail)
  ...
  given toJson: Encoder[DocumentSymbol] =
    ...
    Encoder.recursive: encode_DocumentSymbol =>
      ...
      val encode_selectionRange: Encoder[structures.Range] =
        structures.Range.toJson
      val encode_children: Encoder[Vector[structures.DocumentSymbol]] =
        Encoder.encodeVector(encode_DocumentSymbol)
      Enc.toJsonObject: (enc, a) =>
        enc.field("name", a.name, encode_name)
        a.detail.foreach: v =>
          enc.field("detail", v, encode_detail)
...
end structures_DocumentSymbolCodec
  ...
  given fromJson: Decoder[DocumentSymbolClientCapabilities] =
    ...
    Dec.fromJsonObject: dec =>
      for
        ...
        hierarchicalDocumentSymbolSupport <- dec.getOpt(
          "hierarchicalDocumentSymbolSupport",
          decode_hierarchicalDocumentSymbolSupport
        )
        tagSupport   <- dec.getOpt("tagSupport", decode_tagSupport)
    ...
    Enc.toJsonObject: (enc, a) =>
      ...
      a.hierarchicalDocumentSymbolSupport.foreach: v =>
        enc.field(
          "hierarchicalDocumentSymbolSupport",
          v,
          encode_hierarchicalDocumentSymbolSupport
        )
      a.tagSupport.foreach: v =>
        enc.field("tagSupport", v, encode_tagSupport)
...
private[lsp] trait structures_DocumentSymbolOptionsCodec:
  ...
  given toJson: Encoder[DocumentSymbolOptions] =
    ...
    Enc.toJsonObject: (enc, a) =>
      ...
      a.workDoneProgress.foreach: v =>
        enc.field("workDoneProgress", v, encode_workDoneProgress)
end structures_DocumentSymbolOptionsCodec
...
end structures_DocumentSymbolParamsCodec
...
private[lsp] trait structures_ExecuteCommandOptionsCodec:
  ...
  given toJson: Encoder[ExecuteCommandOptions] =
    // cache all encoders for this type when toJson first initialised
    val encode_commands: Encoder[Vector[String]] =
      Encoder.encodeVector(Encoder.encodeString)
    val encode_workDoneProgress: Encoder[Boolean] = Encoder.encodeBoolean
    Enc.toJsonObject: (enc, a) =>
      ...
      a.workDoneProgress.foreach: v =>
        enc.field("workDoneProgress", v, encode_workDoneProgress)
end structures_ExecuteCommandOptionsCodec
...
end structures_ExecuteCommandParamsCodec
...
private[lsp] trait structures_ExecuteCommandRegistrationOptionsCodec:
  ...
  given fromJson: Decoder[ExecuteCommandRegistrationOptions] =
    ...
    val decode_commands: Decoder[Vector[String]] =
      Decoder.decodeVector(Decoder.decodeString)
    Dec.fromJsonObject: dec =>
      for commands <- dec.get("commands", decode_commands)
  ...
  given toJson: Encoder[ExecuteCommandRegistrationOptions] =
    ...
    Enc.toJsonObject: (enc, a) =>
      enc.field("commands", a.commands, encode_commands)
end structures_ExecuteCommandRegistrationOptionsCodec
...
end structures_ExecutionSummaryCodec
...
private[lsp] trait structures_FileEventCodec:
  ...
  given fromJson: Decoder[FileEvent] =
    // cache all decoders for this type when fromJson first initialised
    val decode_uri: Decoder[runtime.DocumentUri]          = DocumentUri.fromJson
    val decode_type: Decoder[enumerations.FileChangeType] =
      enumerations.FileChangeType.fromJson
    Dec.fromJsonObject: dec =>
      for
        uri    <- dec.get("uri", decode_uri)
  ...
  given toJson: Encoder[FileEvent] =
    // cache all encoders for this type when toJson first initialised
    val encode_uri: Encoder[runtime.DocumentUri]          = DocumentUri.toJson
    val encode_type: Encoder[enumerations.FileChangeType] =
      enumerations.FileChangeType.toJson
    Enc.toJsonObject: (enc, a) =>
      enc.field("uri", a.uri, encode_uri)
      enc.field("type", a.`type`, encode_type)
end structures_FileEventCodec
...
end structures_FileOperationClientCapabilitiesCodec
...
private[lsp] trait structures_FileOperationFilterCodec:
  ...
  given fromJson: Decoder[FileOperationFilter] =
    ...
    val decode_pattern: Decoder[structures.FileOperationPattern] =
      structures.FileOperationPattern.fromJson
    Dec.fromJsonObject: dec =>
      for
  ...
  given toJson: Encoder[FileOperationFilter] =
    ...
    val encode_pattern: Encoder[structures.FileOperationPattern] =
      structures.FileOperationPattern.toJson
    Enc.toJsonObject: (enc, a) =>
      a.scheme.foreach: v =>
        enc.field("scheme", v, encode_scheme)
      enc.field("pattern", a.pattern, encode_pattern)
end structures_FileOperationFilterCodec

private[lsp] trait structures_FileOperationOptionsCodec:
  import structures.*
  given fromJson: Decoder[FileOperationOptions] =
    // cache all decoders for this type when fromJson first initialised
    val decode_didCreate: Decoder[structures.FileOperationRegistrationOptions] =
      structures.FileOperationRegistrationOptions.fromJson
    val decode_willCreate
        : Decoder[structures.FileOperationRegistrationOptions] =
      structures.FileOperationRegistrationOptions.fromJson
    val decode_didRename: Decoder[structures.FileOperationRegistrationOptions] =
      structures.FileOperationRegistrationOptions.fromJson
    val decode_willRename
        : Decoder[structures.FileOperationRegistrationOptions] =
      structures.FileOperationRegistrationOptions.fromJson
    val decode_didDelete: Decoder[structures.FileOperationRegistrationOptions] =
      structures.FileOperationRegistrationOptions.fromJson
    val decode_willDelete
        : Decoder[structures.FileOperationRegistrationOptions] =
      structures.FileOperationRegistrationOptions.fromJson
    Dec.fromJsonObject: dec =>
      for
  ...
  given toJson: Encoder[FileOperationOptions] =
    // cache all encoders for this type when toJson first initialised
    val encode_didCreate: Encoder[structures.FileOperationRegistrationOptions] =
      structures.FileOperationRegistrationOptions.toJson
    val encode_willCreate
        : Encoder[structures.FileOperationRegistrationOptions] =
      structures.FileOperationRegistrationOptions.toJson
    val encode_didRename: Encoder[structures.FileOperationRegistrationOptions] =
      structures.FileOperationRegistrationOptions.toJson
    val encode_willRename
        : Encoder[structures.FileOperationRegistrationOptions] =
      structures.FileOperationRegistrationOptions.toJson
    val encode_didDelete: Encoder[structures.FileOperationRegistrationOptions] =
      structures.FileOperationRegistrationOptions.toJson
    val encode_willDelete
        : Encoder[structures.FileOperationRegistrationOptions] =
      structures.FileOperationRegistrationOptions.toJson
    Enc.toJsonObject: (enc, a) =>
      a.didCreate.foreach: v =>
...
end structures_FileOperationOptionsCodec
...
private[lsp] trait structures_FileOperationPatternCodec:
  ...
  given fromJson: Decoder[FileOperationPattern] =
    ...
    val decode_matches: Decoder[enumerations.FileOperationPatternKind] =
      enumerations.FileOperationPatternKind.fromJson
    val decode_options: Decoder[structures.FileOperationPatternOptions] =
      structures.FileOperationPatternOptions.fromJson
    Dec.fromJsonObject: dec =>
      for
  ...
  given toJson: Encoder[FileOperationPattern] =
    ...
    val encode_matches: Encoder[enumerations.FileOperationPatternKind] =
      enumerations.FileOperationPatternKind.toJson
    val encode_options: Encoder[structures.FileOperationPatternOptions] =
      structures.FileOperationPatternOptions.toJson
    Enc.toJsonObject: (enc, a) =>
...
end structures_FileOperationPatternCodec
...
private[lsp] trait structures_FileOperationPatternOptionsCodec:
  ...
  given fromJson: Decoder[FileOperationPatternOptions] =
    ...
    Dec.fromJsonObject: dec =>
      for ignoreCase <- dec.getOpt("ignoreCase", decode_ignoreCase)
...
end structures_FileOperationPatternOptionsCodec
...
private[lsp] trait structures_FileOperationRegistrationOptionsCodec:
  ...
  given fromJson: Decoder[FileOperationRegistrationOptions] =
    // cache all decoders for this type when fromJson first initialised
    val decode_filters: Decoder[Vector[structures.FileOperationFilter]] =
      Decoder.decodeVector(structures.FileOperationFilter.fromJson)
    Dec.fromJsonObject: dec =>
      for filters <- dec.get("filters", decode_filters)
      yield FileOperationRegistrationOptions(
        filters
      )
  given toJson: Encoder[FileOperationRegistrationOptions] =
    // cache all encoders for this type when toJson first initialised
    val encode_filters: Encoder[Vector[structures.FileOperationFilter]] =
      Encoder.encodeVector(structures.FileOperationFilter.toJson)
    Enc.toJsonObject: (enc, a) =>
      enc.field("filters", a.filters, encode_filters)
end structures_FileOperationRegistrationOptionsCodec
...
end structures_FileRenameCodec

private[lsp] trait structures_FileSystemWatcherCodec:
  import structures.*
  given fromJson: Decoder[FileSystemWatcher] =
    // cache all decoders for this type when fromJson first initialised
    val decode_globPattern: Decoder[aliases.GlobPattern] =
      aliases.GlobPattern.fromJson
    val decode_kind: Decoder[enumerations.WatchKind] =
      enumerations.WatchKind.fromJson
    Dec.fromJsonObject: dec =>
      for
  ...
  given toJson: Encoder[FileSystemWatcher] =
    // cache all encoders for this type when toJson first initialised
    val encode_globPattern: Encoder[aliases.GlobPattern] =
      aliases.GlobPattern.toJson
    val encode_kind: Encoder[enumerations.WatchKind] =
      enumerations.WatchKind.toJson
    Enc.toJsonObject: (enc, a) =>
      enc.field("globPattern", a.globPattern, encode_globPattern)
      a.kind.foreach: v =>
        enc.field("kind", v, encode_kind)
  end toJson
end structures_FileSystemWatcherCodec
...
private[lsp] trait structures_FoldingRangeCodec:
  ...
  given fromJson: Decoder[FoldingRange] =
    ...
    val decode_kind: Decoder[enumerations.FoldingRangeKind] =
      enumerations.FoldingRangeKind.fromJson
  ...
  given toJson: Encoder[FoldingRange] =
    ...
    val encode_kind: Encoder[enumerations.FoldingRangeKind] =
      enumerations.FoldingRangeKind.toJson
...
end structures_FoldingRangeCodec
  ...
  given fromJson: Decoder[FoldingRangeClientCapabilities] =
    ...
    Dec.fromJsonObject: dec =>
      for
        ...
        foldingRangeKind <- dec.getOpt(
          "foldingRangeKind",
          decode_foldingRangeKind
        )
...
private[lsp] trait structures_FoldingRangeOptionsCodec:
  ...
  given toJson: Encoder[FoldingRangeOptions] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.workDoneProgress.foreach: v =>
        enc.field("workDoneProgress", v, encode_workDoneProgress)
end structures_FoldingRangeOptionsCodec
...
end structures_FoldingRangeParamsCodec
  ...
  given fromJson: Decoder[FormattingOptions] =
    ...
    Dec.fromJsonObject: dec =>
      for
        ...
        trimTrailingWhitespace <- dec.getOpt(
          "trimTrailingWhitespace",
          decode_trimTrailingWhitespace
        )
        insertFinalNewline <- dec.getOpt(
          "insertFinalNewline",
          decode_insertFinalNewline
        )
        trimFinalNewlines <- dec.getOpt(
          "trimFinalNewlines",
          decode_trimFinalNewlines
        )
...
end structures_FormattingOptionsCodec
...
private[lsp] trait structures_FullDocumentDiagnosticReportCodec:
  ...
  given fromJson: Decoder[FullDocumentDiagnosticReport] =
    ...
    val decode_items: Decoder[Vector[structures.Diagnostic]] =
      Decoder.decodeVector(structures.Diagnostic.fromJson)
    Dec.fromJsonObject: dec =>
      for
        kind     <- dec.get("kind", decode_kind)
  ...
  given toJson: Encoder[FullDocumentDiagnosticReport] =
    ...
    val encode_items: Encoder[Vector[structures.Diagnostic]] =
      Encoder.encodeVector(structures.Diagnostic.toJson)
    Enc.toJsonObject: (enc, a) =>
      enc.field("kind", a.kind, encode_kind)
...
end structures_FullDocumentDiagnosticReportCodec
...
private[lsp] trait structures_GeneralClientCapabilitiesCodec:
  ...
  given fromJson: Decoder[GeneralClientCapabilities] =
    ...
    val decode_markdown: Decoder[structures.MarkdownClientCapabilities] =
      structures.MarkdownClientCapabilities.fromJson
    val decode_positionEncodings
        : Decoder[Vector[enumerations.PositionEncodingKind]] =
      Decoder.decodeVector(enumerations.PositionEncodingKind.fromJson)
    Dec.fromJsonObject: dec =>
      for
        staleRequestSupport <- dec.getOpt(
          "staleRequestSupport",
          decode_staleRequestSupport
        )
        regularExpressions <- dec.getOpt(
          "regularExpressions",
          decode_regularExpressions
        )
        markdown          <- dec.getOpt("markdown", decode_markdown)
        positionEncodings <- dec.getOpt(
          "positionEncodings",
          decode_positionEncodings
        )
  ...
  given toJson: Encoder[GeneralClientCapabilities] =
    ...
    val encode_markdown: Encoder[structures.MarkdownClientCapabilities] =
      structures.MarkdownClientCapabilities.toJson
    val encode_positionEncodings
        : Encoder[Vector[enumerations.PositionEncodingKind]] =
      Encoder.encodeVector(enumerations.PositionEncodingKind.toJson)
    Enc.toJsonObject: (enc, a) =>
...
private[lsp] trait structures_HoverCodec:
  ...
  given fromJson: Decoder[Hover] =
    // cache all decoders for this type when fromJson first initialised
    val decode_contents: Decoder[
      (structures.MarkupContent | aliases.MarkedString |
        Vector[aliases.MarkedString])
    ] = Dec.union3[structures.MarkupContent, aliases.MarkedString, Vector[
      aliases.MarkedString
    ]](
      structures.MarkupContent.fromJson,
      aliases.MarkedString.fromJson,
      Decoder.decodeVector(aliases.MarkedString.fromJson)
    )
    val decode_range: Decoder[structures.Range] = structures.Range.fromJson
    Dec.fromJsonObject: dec =>
      for
  ...
  given toJson: Encoder[Hover] =
    // cache all encoders for this type when toJson first initialised
    val encode_contents: Encoder[
      (structures.MarkupContent | aliases.MarkedString |
        Vector[aliases.MarkedString])
    ] = Enc.union3[structures.MarkupContent, aliases.MarkedString, Vector[
      aliases.MarkedString
    ]](
      structures.MarkupContent.toJson,
      aliases.MarkedString.toJson,
      Encoder.encodeVector(aliases.MarkedString.toJson)
    )
    val encode_range: Encoder[structures.Range] = structures.Range.toJson
    Enc.toJsonObject: (enc, a) =>
...
private[lsp] trait structures_HoverClientCapabilitiesCodec:
  ...
  given fromJson: Decoder[HoverClientCapabilities] =
    // cache all decoders for this type when fromJson first initialised
    val decode_dynamicRegistration: Decoder[Boolean] = Decoder.decodeBoolean
    val decode_contentFormat: Decoder[Vector[enumerations.MarkupKind]] =
      Decoder.decodeVector(enumerations.MarkupKind.fromJson)
    Dec.fromJsonObject: dec =>
      for
        dynamicRegistration <- dec.getOpt(
  ...
  given toJson: Encoder[HoverClientCapabilities] =
    // cache all encoders for this type when toJson first initialised
    val encode_dynamicRegistration: Encoder[Boolean] = Encoder.encodeBoolean
    val encode_contentFormat: Encoder[Vector[enumerations.MarkupKind]] =
      Encoder.encodeVector(enumerations.MarkupKind.toJson)
    Enc.toJsonObject: (enc, a) =>
      a.dynamicRegistration.foreach: v =>
        enc.field("dynamicRegistration", v, encode_dynamicRegistration)
...
end structures_HoverClientCapabilitiesCodec
...
private[lsp] trait structures_HoverOptionsCodec:
  ...
  given toJson: Encoder[HoverOptions] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.workDoneProgress.foreach: v =>
        enc.field("workDoneProgress", v, encode_workDoneProgress)
end structures_HoverOptionsCodec
...
end structures_HoverParamsCodec
...
private[lsp] trait structures_HoverRegistrationOptionsCodec:
  ...
  given toJson: Encoder[HoverRegistrationOptions] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.documentSelector.foreach: v =>
        enc.field("documentSelector", v, encode_documentSelector)
end structures_HoverRegistrationOptionsCodec
...
private[lsp] trait structures_ImplementationClientCapabilitiesCodec:
  ...
  given toJson: Encoder[ImplementationClientCapabilities] =
    ...
    Enc.toJsonObject: (enc, a) =>
      ...
      a.linkSupport.foreach: v =>
        enc.field("linkSupport", v, encode_linkSupport)
end structures_ImplementationClientCapabilitiesCodec
...
private[lsp] trait structures_ImplementationOptionsCodec:
  ...
  given toJson: Encoder[ImplementationOptions] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.workDoneProgress.foreach: v =>
        enc.field("workDoneProgress", v, encode_workDoneProgress)
end structures_ImplementationOptionsCodec
...
end structures_ImplementationParamsCodec
...
end structures_ImplementationRegistrationOptionsCodec
...
private[lsp] trait structures_InitializeErrorCodec:
  ...
  given fromJson: Decoder[InitializeError] =
    ...
    Dec.fromJsonObject: dec =>
      for retry <- dec.get("retry", decode_retry)
...
end structures_InitializeErrorCodec
...
private[lsp] trait structures_InitializeParamsCodec:
  ...
  given fromJson: Decoder[InitializeParams] =
    ...
    val decode_capabilities: Decoder[structures.ClientCapabilities] =
    ...
    Dec.fromJsonObject: dec =>
      for
        ...
        initializationOptions <- dec.getOpt(
          "initializationOptions",
          decode_initializationOptions
        )
  ...
  given toJson: Encoder[InitializeParams] =
    ...
    val encode_capabilities: Encoder[structures.ClientCapabilities] =
...
private[lsp] trait structures_InlayHintCodec:
  ...
  given fromJson: Decoder[InlayHint] =
    ...
    val decode_position: Decoder[structures.Position] =
      structures.Position.fromJson
    val decode_label
        : Decoder[(String | Vector[structures.InlayHintLabelPart])] =
      Dec.union2[String, Vector[structures.InlayHintLabelPart]](
        Decoder.decodeString,
        Decoder.decodeVector(structures.InlayHintLabelPart.fromJson)
      )
    val decode_kind: Decoder[enumerations.InlayHintKind] =
      enumerations.InlayHintKind.fromJson
    val decode_textEdits: Decoder[Vector[structures.TextEdit]] =
      Decoder.decodeVector(structures.TextEdit.fromJson)
    val decode_tooltip: Decoder[(String | structures.MarkupContent)] =
      Dec.union2[String, structures.MarkupContent](
        Decoder.decodeString,
        structures.MarkupContent.fromJson
      )
  ...
  given toJson: Encoder[InlayHint] =
    ...
    val encode_position: Encoder[structures.Position] =
      structures.Position.toJson
    val encode_label
        : Encoder[(String | Vector[structures.InlayHintLabelPart])] =
      Enc.union2[String, Vector[structures.InlayHintLabelPart]](
        Encoder.encodeString,
        Encoder.encodeVector(structures.InlayHintLabelPart.toJson)
      )
    val encode_kind: Encoder[enumerations.InlayHintKind] =
      enumerations.InlayHintKind.toJson
    val encode_textEdits: Encoder[Vector[structures.TextEdit]] =
      Encoder.encodeVector(structures.TextEdit.toJson)
    val encode_tooltip: Encoder[(String | structures.MarkupContent)] =
      Enc.union2[String, structures.MarkupContent](
        Encoder.encodeString,
        structures.MarkupContent.toJson
      )
...
end structures_InlayHintLabelPartCodec
...
private[lsp] trait structures_InlayHintOptionsCodec:
  ...
  given toJson: Encoder[InlayHintOptions] =
    ...
    Enc.toJsonObject: (enc, a) =>
      ...
      a.workDoneProgress.foreach: v =>
        enc.field("workDoneProgress", v, encode_workDoneProgress)
end structures_InlayHintOptionsCodec
...
end structures_InlayHintParamsCodec
...
end structures_InlayHintRegistrationOptionsCodec
...
private[lsp] trait structures_InlineValueClientCapabilitiesCodec:
  ...
  given toJson: Encoder[InlineValueClientCapabilities] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.dynamicRegistration.foreach: v =>
        enc.field("dynamicRegistration", v, encode_dynamicRegistration)
end structures_InlineValueClientCapabilitiesCodec
...
private[lsp] trait structures_InlineValueContextCodec:
  ...
  given fromJson: Decoder[InlineValueContext] =
    ...
    val decode_stoppedLocation: Decoder[structures.Range] =
      structures.Range.fromJson
    Dec.fromJsonObject: dec =>
      for
...
end structures_InlineValueEvaluatableExpressionCodec
...
private[lsp] trait structures_InlineValueOptionsCodec:
  ...
  given toJson: Encoder[InlineValueOptions] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.workDoneProgress.foreach: v =>
        enc.field("workDoneProgress", v, encode_workDoneProgress)
end structures_InlineValueOptionsCodec
...
private[lsp] trait structures_InlineValueParamsCodec:
  ...
  given fromJson: Decoder[InlineValueParams] =
    ...
    val decode_textDocument: Decoder[structures.TextDocumentIdentifier] =
      structures.TextDocumentIdentifier.fromJson
    val decode_range: Decoder[structures.Range] = structures.Range.fromJson
    val decode_context: Decoder[structures.InlineValueContext] =
      structures.InlineValueContext.fromJson
    val decode_workDoneToken: Decoder[aliases.ProgressToken] =
      aliases.ProgressToken.fromJson
    Dec.fromJsonObject: dec =>
      for
  ...
  given toJson: Encoder[InlineValueParams] =
    ...
    val encode_textDocument: Encoder[structures.TextDocumentIdentifier] =
      structures.TextDocumentIdentifier.toJson
    val encode_range: Encoder[structures.Range] = structures.Range.toJson
    val encode_context: Encoder[structures.InlineValueContext] =
      structures.InlineValueContext.toJson
    val encode_workDoneToken: Encoder[aliases.ProgressToken] =
      aliases.ProgressToken.toJson
    Enc.toJsonObject: (enc, a) =>
      enc.field("textDocument", a.textDocument, encode_textDocument)
...
end structures_InlineValueParamsCodec
...
end structures_InlineValueRegistrationOptionsCodec
...
end structures_InlineValueTextCodec
  ...
  given fromJson: Decoder[InlineValueVariableLookup] =
    ...
    Dec.fromJsonObject: dec =>
      for
        ...
        caseSensitiveLookup <- dec.get(
          "caseSensitiveLookup",
          decode_caseSensitiveLookup
        )
  ...
  given toJson: Encoder[InlineValueVariableLookup] =
    ...
    Enc.toJsonObject: (enc, a) =>
      ...
      enc.field(
        ...
        encode_caseSensitiveLookup
      )
  end toJson
end structures_InlineValueVariableLookupCodec
...
private[lsp] trait structures_InlineValueWorkspaceClientCapabilitiesCodec:
  ...
  given toJson: Encoder[InlineValueWorkspaceClientCapabilities] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.refreshSupport.foreach: v =>
        enc.field("refreshSupport", v, encode_refreshSupport)
end structures_InlineValueWorkspaceClientCapabilitiesCodec
...
private[lsp] trait structures_InsertReplaceEditCodec:
  ...
  given toJson: Encoder[InsertReplaceEdit] =
    ...
    Enc.toJsonObject: (enc, a) =>
      ...
      enc.field("insert", a.insert, encode_insert)
      enc.field("replace", a.replace, encode_replace)
end structures_InsertReplaceEditCodec
...
private[lsp] trait structures_LinkedEditingRangeClientCapabilitiesCodec:
  ...
  given toJson: Encoder[LinkedEditingRangeClientCapabilities] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.dynamicRegistration.foreach: v =>
        enc.field("dynamicRegistration", v, encode_dynamicRegistration)
end structures_LinkedEditingRangeClientCapabilitiesCodec
...
private[lsp] trait structures_LinkedEditingRangeOptionsCodec:
  ...
  given toJson: Encoder[LinkedEditingRangeOptions] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.workDoneProgress.foreach: v =>
        enc.field("workDoneProgress", v, encode_workDoneProgress)
end structures_LinkedEditingRangeOptionsCodec
...
end structures_LinkedEditingRangeParamsCodec
...
end structures_LinkedEditingRangeRegistrationOptionsCodec
...
end structures_LinkedEditingRangesCodec
...
private[lsp] trait structures_LocationCodec:
  ...
  given toJson: Encoder[Location] =
    ...
    Enc.toJsonObject: (enc, a) =>
      enc.field("uri", a.uri, encode_uri)
      enc.field("range", a.range, encode_range)
end structures_LocationCodec

private[lsp] trait structures_LocationLinkCodec:
  import structures.*
  given fromJson: Decoder[LocationLink] =
    // cache all decoders for this type when fromJson first initialised
    val decode_originSelectionRange: Decoder[structures.Range] =
      structures.Range.fromJson
    val decode_targetUri: Decoder[runtime.DocumentUri] = DocumentUri.fromJson
    val decode_targetRange: Decoder[structures.Range]  =
      structures.Range.fromJson
    val decode_targetSelectionRange: Decoder[structures.Range] =
      structures.Range.fromJson
    Dec.fromJsonObject: dec =>
      for
        originSelectionRange <- dec.getOpt(
          "originSelectionRange",
          decode_originSelectionRange
        )
        targetUri            <- dec.get("targetUri", decode_targetUri)
        targetRange          <- dec.get("targetRange", decode_targetRange)
        targetSelectionRange <- dec.get(
          "targetSelectionRange",
          decode_targetSelectionRange
        )
      yield LocationLink(
        originSelectionRange,
        targetUri,
  ...
  given toJson: Encoder[LocationLink] =
    // cache all encoders for this type when toJson first initialised
    val encode_originSelectionRange: Encoder[structures.Range] =
      structures.Range.toJson
    ...
    val encode_targetSelectionRange: Encoder[structures.Range] =
      structures.Range.toJson
    Enc.toJsonObject: (enc, a) =>
      ...
      enc.field(
        "targetSelectionRange",
        a.targetSelectionRange,
        encode_targetSelectionRange
      )
  end toJson
...
private[lsp] trait structures_LogMessageParamsCodec:
  ...
  given fromJson: Decoder[LogMessageParams] =
    // cache all decoders for this type when fromJson first initialised
    val decode_type: Decoder[enumerations.MessageType] =
      enumerations.MessageType.fromJson
    val decode_message: Decoder[String] = Decoder.decodeString
    Dec.fromJsonObject: dec =>
      for
        `type`  <- dec.get("type", decode_type)
  ...
  given toJson: Encoder[LogMessageParams] =
    // cache all encoders for this type when toJson first initialised
    val encode_type: Encoder[enumerations.MessageType] =
      enumerations.MessageType.toJson
    val encode_message: Encoder[String] = Encoder.encodeString
    Enc.toJsonObject: (enc, a) =>
      enc.field("type", a.`type`, encode_type)
      enc.field("message", a.message, encode_message)
end structures_LogMessageParamsCodec
...
end structures_LogTraceParamsCodec
...
private[lsp] trait structures_MarkdownClientCapabilitiesCodec:
  ...
  given fromJson: Decoder[MarkdownClientCapabilities] =
    ...
    val decode_version: Decoder[String]             = Decoder.decodeString
    val decode_allowedTags: Decoder[Vector[String]] =
      Decoder.decodeVector(Decoder.decodeString)
    Dec.fromJsonObject: dec =>
      for
  ...
  given toJson: Encoder[MarkdownClientCapabilities] =
    ...
    val encode_version: Encoder[String]             = Encoder.encodeString
    val encode_allowedTags: Encoder[Vector[String]] =
      Encoder.encodeVector(Encoder.encodeString)
    Enc.toJsonObject: (enc, a) =>
...
private[lsp] trait structures_MarkupContentCodec:
  ...
  given fromJson: Decoder[MarkupContent] =
    // cache all decoders for this type when fromJson first initialised
    val decode_kind: Decoder[enumerations.MarkupKind] =
      enumerations.MarkupKind.fromJson
    val decode_value: Decoder[String] = Decoder.decodeString
    Dec.fromJsonObject: dec =>
      for
        kind  <- dec.get("kind", decode_kind)
  ...
  given toJson: Encoder[MarkupContent] =
    // cache all encoders for this type when toJson first initialised
    val encode_kind: Encoder[enumerations.MarkupKind] =
      enumerations.MarkupKind.toJson
    val encode_value: Encoder[String] = Encoder.encodeString
    Enc.toJsonObject: (enc, a) =>
      enc.field("kind", a.kind, encode_kind)
      enc.field("value", a.value, encode_value)
end structures_MarkupContentCodec
...
private[lsp] trait structures_MessageActionItemCodec:
  ...
  given fromJson: Decoder[MessageActionItem] =
    ...
    val decode_title: Decoder[String] = Decoder.decodeString
    Dec.fromJsonObject: dec =>
      for title <- dec.get("title", decode_title)
  ...
  given toJson: Encoder[MessageActionItem] =
    ...
    Enc.toJsonObject: (enc, a) =>
      enc.field("title", a.title, encode_title)
end structures_MessageActionItemCodec
...
private[lsp] trait structures_MonikerCodec:
  ...
  given fromJson: Decoder[Moniker] =
    ...
    val decode_scheme: Decoder[String]     = Decoder.decodeString
    val decode_identifier: Decoder[String] = Decoder.decodeString
    val decode_unique: Decoder[enumerations.UniquenessLevel] =
      enumerations.UniquenessLevel.fromJson
    val decode_kind: Decoder[enumerations.MonikerKind] =
      enumerations.MonikerKind.fromJson
    Dec.fromJsonObject: dec =>
      for
  ...
  given toJson: Encoder[Moniker] =
    ...
    val encode_scheme: Encoder[String]     = Encoder.encodeString
    val encode_identifier: Encoder[String] = Encoder.encodeString
    val encode_unique: Encoder[enumerations.UniquenessLevel] =
      enumerations.UniquenessLevel.toJson
    val encode_kind: Encoder[enumerations.MonikerKind] =
      enumerations.MonikerKind.toJson
    Enc.toJsonObject: (enc, a) =>
...
private[lsp] trait structures_MonikerClientCapabilitiesCodec:
  ...
  given toJson: Encoder[MonikerClientCapabilities] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.dynamicRegistration.foreach: v =>
        enc.field("dynamicRegistration", v, encode_dynamicRegistration)
end structures_MonikerClientCapabilitiesCodec
...
private[lsp] trait structures_MonikerOptionsCodec:
  ...
  given toJson: Encoder[MonikerOptions] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.workDoneProgress.foreach: v =>
        enc.field("workDoneProgress", v, encode_workDoneProgress)
end structures_MonikerOptionsCodec
...
end structures_MonikerParamsCodec
...
private[lsp] trait structures_MonikerRegistrationOptionsCodec:
  ...
  given toJson: Encoder[MonikerRegistrationOptions] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.documentSelector.foreach: v =>
        enc.field("documentSelector", v, encode_documentSelector)
end structures_MonikerRegistrationOptionsCodec

private[lsp] trait structures_NotebookCellCodec:
  import structures.*
  given fromJson: Decoder[NotebookCell] =
    // cache all decoders for this type when fromJson first initialised
    val decode_kind: Decoder[enumerations.NotebookCellKind] =
      enumerations.NotebookCellKind.fromJson
    ...
    val decode_executionSummary: Decoder[structures.ExecutionSummary] =
      structures.ExecutionSummary.fromJson
    Dec.fromJsonObject: dec =>
      for
        kind             <- dec.get("kind", decode_kind)
        document         <- dec.get("document", decode_document)
        metadata         <- dec.getOpt("metadata", decode_metadata)
        executionSummary <- dec.getOpt(
          "executionSummary",
          decode_executionSummary
        )
      yield NotebookCell(
        kind,
        document,
  ...
  given toJson: Encoder[NotebookCell] =
    // cache all encoders for this type when toJson first initialised
    val encode_kind: Encoder[enumerations.NotebookCellKind] =
      enumerations.NotebookCellKind.toJson
    ...
    val encode_executionSummary: Encoder[structures.ExecutionSummary] =
      structures.ExecutionSummary.toJson
    Enc.toJsonObject: (enc, a) =>
      enc.field("kind", a.kind, encode_kind)
...
end structures_NotebookCellCodec
...
private[lsp] trait structures_NotebookCellArrayChangeCodec:
  ...
  given fromJson: Decoder[NotebookCellArrayChange] =
    ...
    val decode_cells: Decoder[Vector[structures.NotebookCell]] =
  ...
  given toJson: Encoder[NotebookCellArrayChange] =
    ...
    val encode_cells: Encoder[Vector[structures.NotebookCell]] =
...
end structures_NotebookCellTextDocumentFilterCodec
...
private[lsp] trait structures_NotebookDocumentCellChangeStructureCodec:
  ...
  given fromJson: Decoder[NotebookDocumentCellChangeStructure] =
    ...
    val decode_didOpen: Decoder[Vector[structures.TextDocumentItem]] =
      Decoder.decodeVector(structures.TextDocumentItem.fromJson)
    val decode_didClose: Decoder[Vector[structures.TextDocumentIdentifier]] =
      Decoder.decodeVector(structures.TextDocumentIdentifier.fromJson)
    Dec.fromJsonObject: dec =>
      for
  ...
  given toJson: Encoder[NotebookDocumentCellChangeStructure] =
    ...
    val encode_didOpen: Encoder[Vector[structures.TextDocumentItem]] =
      Encoder.encodeVector(structures.TextDocumentItem.toJson)
    val encode_didClose: Encoder[Vector[structures.TextDocumentIdentifier]] =
      Encoder.encodeVector(structures.TextDocumentIdentifier.toJson)
    Enc.toJsonObject: (enc, a) =>
...
private[lsp] trait structures_NotebookDocumentClientCapabilitiesCodec:
  ...
  given fromJson: Decoder[NotebookDocumentClientCapabilities] =
    ...
    val decode_synchronization
        : Decoder[structures.NotebookDocumentSyncClientCapabilities] =
      structures.NotebookDocumentSyncClientCapabilities.fromJson
    Dec.fromJsonObject: dec =>
      for synchronization <- dec.get("synchronization", decode_synchronization)
  ...
  given toJson: Encoder[NotebookDocumentClientCapabilities] =
    ...
    val encode_synchronization
        : Encoder[structures.NotebookDocumentSyncClientCapabilities] =
      structures.NotebookDocumentSyncClientCapabilities.toJson
    Enc.toJsonObject: (enc, a) =>
...
private[lsp] trait structures_NotebookDocumentIdentifierCodec:
  ...
  given toJson: Encoder[NotebookDocumentIdentifier] =
    ...
    Enc.toJsonObject: (enc, a) =>
      enc.field("uri", a.uri, encode_uri)
end structures_NotebookDocumentIdentifierCodec
  ...
  given fromJson: Decoder[NotebookDocumentSyncClientCapabilities] =
    ...
    Dec.fromJsonObject: dec =>
      for
        ...
        executionSummarySupport <- dec.getOpt(
          "executionSummarySupport",
          decode_executionSummarySupport
        )
...
end structures_NotebookDocumentSyncClientCapabilitiesCodec
  ...
  given toJson: Encoder[OptionalVersionedTextDocumentIdentifier] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.version.foreach: v =>
        enc.field("version", v, encode_version)
      enc.field("uri", a.uri, encode_uri)
end structures_OptionalVersionedTextDocumentIdentifierCodec

private[lsp] trait structures_ParameterInformationCodec:
  import structures.*
  given fromJson: Decoder[ParameterInformation] =
    // cache all decoders for this type when fromJson first initialised
    val decode_label: Decoder[(String | (runtime.uinteger, runtime.uinteger))] =
      Dec.union2[String, (runtime.uinteger, runtime.uinteger)](
        Decoder.decodeString,
        Decoder.decodeTuple2(uinteger.fromJson, uinteger.fromJson)
      )
    val decode_documentation: Decoder[(String | structures.MarkupContent)] =
      Dec.union2[String, structures.MarkupContent](
        Decoder.decodeString,
  ...
  given toJson: Encoder[ParameterInformation] =
    // cache all encoders for this type when toJson first initialised
    val encode_label: Encoder[(String | (runtime.uinteger, runtime.uinteger))] =
      Enc.union2[String, (runtime.uinteger, runtime.uinteger)](
        Encoder.encodeString,
        Encoder.encodeTuple2(uinteger.toJson, uinteger.toJson)
      )
    val encode_documentation: Encoder[(String | structures.MarkupContent)] =
      Enc.union2[String, structures.MarkupContent](
        Encoder.encodeString,
...
end structures_ParameterInformationCodec
...
private[lsp] trait structures_PartialResultParamsCodec:
  ...
  given fromJson: Decoder[PartialResultParams] =
    ...
    val decode_partialResultToken: Decoder[aliases.ProgressToken] =
      aliases.ProgressToken.fromJson
    Dec.fromJsonObject: dec =>
      for partialResultToken <- dec.getOpt(
          "partialResultToken",
          decode_partialResultToken
        )
  ...
  given toJson: Encoder[PartialResultParams] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.partialResultToken.foreach: v =>
        enc.field("partialResultToken", v, encode_partialResultToken)
end structures_PartialResultParamsCodec
...
end structures_PublishDiagnosticsParamsCodec

private[lsp] trait structures_RangeCodec:
  import structures.*
  given fromJson: Decoder[Range] =
    // cache all decoders for this type when fromJson first initialised
    val decode_start: Decoder[structures.Position] =
      structures.Position.fromJson
...
private[lsp] trait structures_ReferenceClientCapabilitiesCodec:
  ...
  given toJson: Encoder[ReferenceClientCapabilities] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.dynamicRegistration.foreach: v =>
        enc.field("dynamicRegistration", v, encode_dynamicRegistration)
end structures_ReferenceClientCapabilitiesCodec
...
private[lsp] trait structures_ReferenceContextCodec:
  ...
  given fromJson: Decoder[ReferenceContext] =
    ...
    Dec.fromJsonObject: dec =>
      for includeDeclaration <- dec.get(
          "includeDeclaration",
          decode_includeDeclaration
        )
  ...
  given toJson: Encoder[ReferenceContext] =
    ...
    Enc.toJsonObject: (enc, a) =>
      enc.field(
        ...
        encode_includeDeclaration
      )
end structures_ReferenceContextCodec
...
private[lsp] trait structures_ReferenceOptionsCodec:
  ...
  given toJson: Encoder[ReferenceOptions] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.workDoneProgress.foreach: v =>
        enc.field("workDoneProgress", v, encode_workDoneProgress)
end structures_ReferenceOptionsCodec

private[lsp] trait structures_ReferenceParamsCodec:
  import structures.*
  given fromJson: Decoder[ReferenceParams] =
    // cache all decoders for this type when fromJson first initialised
    val decode_context: Decoder[structures.ReferenceContext] =
      structures.ReferenceContext.fromJson
    val decode_textDocument: Decoder[structures.TextDocumentIdentifier] =
      structures.TextDocumentIdentifier.fromJson
    val decode_position: Decoder[structures.Position] =
      structures.Position.fromJson
  ...
  given toJson: Encoder[ReferenceParams] =
    // cache all encoders for this type when toJson first initialised
    val encode_context: Encoder[structures.ReferenceContext] =
      structures.ReferenceContext.toJson
    val encode_textDocument: Encoder[structures.TextDocumentIdentifier] =
      structures.TextDocumentIdentifier.toJson
    val encode_position: Encoder[structures.Position] =
      structures.Position.toJson
...
end structures_ReferenceParamsCodec
...
private[lsp] trait structures_ReferenceRegistrationOptionsCodec:
  ...
  given toJson: Encoder[ReferenceRegistrationOptions] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.documentSelector.foreach: v =>
        enc.field("documentSelector", v, encode_documentSelector)
end structures_ReferenceRegistrationOptionsCodec
...
end structures_RegistrationCodec

private[lsp] trait structures_RegistrationParamsCodec:
  import structures.*
  given fromJson: Decoder[RegistrationParams] =
    // cache all decoders for this type when fromJson first initialised
    val decode_registrations: Decoder[Vector[structures.Registration]] =
      Decoder.decodeVector(structures.Registration.fromJson)
    Dec.fromJsonObject: dec =>
      for registrations <- dec.get("registrations", decode_registrations)
      yield RegistrationParams(
        registrations
      )
  given toJson: Encoder[RegistrationParams] =
    // cache all encoders for this type when toJson first initialised
    val encode_registrations: Encoder[Vector[structures.Registration]] =
      Encoder.encodeVector(structures.Registration.toJson)
    Enc.toJsonObject: (enc, a) =>
      enc.field("registrations", a.registrations, encode_registrations)
end structures_RegistrationParamsCodec
...
private[lsp] trait structures_RegularExpressionsClientCapabilitiesCodec:
  ...
  given toJson: Encoder[RegularExpressionsClientCapabilities] =
    ...
    Enc.toJsonObject: (enc, a) =>
      ...
      a.version.foreach: v =>
        enc.field("version", v, encode_version)
end structures_RegularExpressionsClientCapabilitiesCodec
...
end structures_RelatedFullDocumentDiagnosticReportCodec
...
private[lsp] trait structures_RelatedUnchangedDocumentDiagnosticReportCodec:
  ...
  given fromJson: Decoder[RelatedUnchangedDocumentDiagnosticReport] =
    ...
    val decode_kind: Decoder["unchanged"] =
      Decoder.decodeLiteralString["unchanged"]
    val decode_resultId: Decoder[String] = Decoder.decodeString
    Dec.fromJsonObject: dec =>
      for
        relatedDocuments <- dec.getOpt(
  ...
  given toJson: Encoder[RelatedUnchangedDocumentDiagnosticReport] =
    ...
    val encode_kind: Encoder["unchanged"] =
      Encoder.encodeLiteralString["unchanged"]
    val encode_resultId: Encoder[String] = Encoder.encodeString
    Enc.toJsonObject: (enc, a) =>
      a.relatedDocuments.foreach: v =>
        enc.field("relatedDocuments", v, encode_relatedDocuments)
...
end structures_RelatedUnchangedDocumentDiagnosticReportCodec

private[lsp] trait structures_RelativePatternCodec:
  import structures.*
  given fromJson: Decoder[RelativePattern] =
    // cache all decoders for this type when fromJson first initialised
    val decode_baseUri: Decoder[(structures.WorkspaceFolder | runtime.Uri)] =
      Dec.union2[structures.WorkspaceFolder, runtime.Uri](
        structures.WorkspaceFolder.fromJson,
        Uri.fromJson
      )
  ...
  given toJson: Encoder[RelativePattern] =
    // cache all encoders for this type when toJson first initialised
    val encode_baseUri: Encoder[(structures.WorkspaceFolder | runtime.Uri)] =
      Enc.union2[structures.WorkspaceFolder, runtime.Uri](
        structures.WorkspaceFolder.toJson,
        Uri.toJson
      )
...
end structures_RelativePatternCodec
...
private[lsp] trait structures_RenameClientCapabilitiesCodec:
  ...
  given fromJson: Decoder[RenameClientCapabilities] =
    ...
    val decode_prepareSupportDefaultBehavior
        : Decoder[enumerations.PrepareSupportDefaultBehavior] =
      enumerations.PrepareSupportDefaultBehavior.fromJson
    val decode_honorsChangeAnnotations: Decoder[Boolean] = Decoder.decodeBoolean
    Dec.fromJsonObject: dec =>
      for
        dynamicRegistration <- dec.getOpt(
        ...
        prepareSupportDefaultBehavior <- dec.getOpt(
          "prepareSupportDefaultBehavior",
          decode_prepareSupportDefaultBehavior
        )
        honorsChangeAnnotations <- dec.getOpt(
          "honorsChangeAnnotations",
          decode_honorsChangeAnnotations
  ...
  given toJson: Encoder[RenameClientCapabilities] =
    ...
    val encode_prepareSupportDefaultBehavior
        : Encoder[enumerations.PrepareSupportDefaultBehavior] =
      enumerations.PrepareSupportDefaultBehavior.toJson
    val encode_honorsChangeAnnotations: Encoder[Boolean] = Encoder.encodeBoolean
    Enc.toJsonObject: (enc, a) =>
      a.dynamicRegistration.foreach: v =>
        enc.field("dynamicRegistration", v, encode_dynamicRegistration)
      ...
      a.prepareSupportDefaultBehavior.foreach: v =>
        enc.field(
          "prepareSupportDefaultBehavior",
          v,
          encode_prepareSupportDefaultBehavior
        )
      a.honorsChangeAnnotations.foreach: v =>
        enc.field("honorsChangeAnnotations", v, encode_honorsChangeAnnotations)
  end toJson
end structures_RenameClientCapabilitiesCodec
...
private[lsp] trait structures_RenameFileCodec:
  ...
  given fromJson: Decoder[RenameFile] =
    ...
    val decode_oldUri: Decoder[runtime.DocumentUri] = DocumentUri.fromJson
    val decode_newUri: Decoder[runtime.DocumentUri] = DocumentUri.fromJson
    val decode_options: Decoder[structures.RenameFileOptions] =
      structures.RenameFileOptions.fromJson
    val decode_annotationId: Decoder[aliases.ChangeAnnotationIdentifier] =
      aliases.ChangeAnnotationIdentifier.fromJson
    Dec.fromJsonObject: dec =>
      for
  ...
  given toJson: Encoder[RenameFile] =
    ...
    val encode_oldUri: Encoder[runtime.DocumentUri] = DocumentUri.toJson
    val encode_newUri: Encoder[runtime.DocumentUri] = DocumentUri.toJson
    val encode_options: Encoder[structures.RenameFileOptions] =
      structures.RenameFileOptions.toJson
    val encode_annotationId: Encoder[aliases.ChangeAnnotationIdentifier] =
      aliases.ChangeAnnotationIdentifier.toJson
    Enc.toJsonObject: (enc, a) =>
      enc.field("kind", a.kind, encode_kind)
...
end structures_RenameFileCodec
...
private[lsp] trait structures_RenameFileOptionsCodec:
  ...
  given toJson: Encoder[RenameFileOptions] =
    ...
    Enc.toJsonObject: (enc, a) =>
      ...
      a.ignoreIfExists.foreach: v =>
        enc.field("ignoreIfExists", v, encode_ignoreIfExists)
end structures_RenameFileOptionsCodec

private[lsp] trait structures_RenameFilesParamsCodec:
  import structures.*
  given fromJson: Decoder[RenameFilesParams] =
    // cache all decoders for this type when fromJson first initialised
    val decode_files: Decoder[Vector[structures.FileRename]] =
      Decoder.decodeVector(structures.FileRename.fromJson)
    Dec.fromJsonObject: dec =>
      for files <- dec.get("files", decode_files)
  ...
  given toJson: Encoder[RenameFilesParams] =
    // cache all encoders for this type when toJson first initialised
    val encode_files: Encoder[Vector[structures.FileRename]] =
      Encoder.encodeVector(structures.FileRename.toJson)
    Enc.toJsonObject: (enc, a) =>
      enc.field("files", a.files, encode_files)
end structures_RenameFilesParamsCodec
...
private[lsp] trait structures_RenameOptionsCodec:
  ...
  given toJson: Encoder[RenameOptions] =
    ...
    Enc.toJsonObject: (enc, a) =>
      ...
      a.workDoneProgress.foreach: v =>
        enc.field("workDoneProgress", v, encode_workDoneProgress)
end structures_RenameOptionsCodec
...
end structures_RenameParamsCodec
...
end structures_RenameRegistrationOptionsCodec
...
private[lsp] trait structures_ResourceOperationCodec:
  ...
  given toJson: Encoder[ResourceOperation] =
    ...
    Enc.toJsonObject: (enc, a) =>
      ...
      a.annotationId.foreach: v =>
        enc.field("annotationId", v, encode_annotationId)
end structures_ResourceOperationCodec
...
private[lsp] trait structures_SaveOptionsCodec:
  ...
  given fromJson: Decoder[SaveOptions] =
    ...
    Dec.fromJsonObject: dec =>
      for includeText <- dec.getOpt("includeText", decode_includeText)
      yield SaveOptions(
        includeText
      )
...
private[lsp] trait structures_SelectionRangeCodec:
  ...
  given fromJson: Decoder[SelectionRange] =
    ...
    Decoder.recursive: decode_SelectionRange =>
      val decode_range: Decoder[structures.Range] = structures.Range.fromJson
      val decode_parent: Decoder[structures.SelectionRange] =
        decode_SelectionRange
      Dec.fromJsonObject: dec =>
        for
          range  <- dec.get("range", decode_range)
  ...
  given toJson: Encoder[SelectionRange] =
    ...
    Encoder.recursive: encode_SelectionRange =>
      val encode_range: Encoder[structures.Range] = structures.Range.toJson
      val encode_parent: Encoder[structures.SelectionRange] =
        encode_SelectionRange
      Enc.toJsonObject: (enc, a) =>
        enc.field("range", a.range, encode_range)
        a.parent.foreach: v =>
          enc.field("parent", v, encode_parent)
end structures_SelectionRangeCodec
...
private[lsp] trait structures_SelectionRangeClientCapabilitiesCodec:
  ...
  given toJson: Encoder[SelectionRangeClientCapabilities] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.dynamicRegistration.foreach: v =>
        enc.field("dynamicRegistration", v, encode_dynamicRegistration)
end structures_SelectionRangeClientCapabilitiesCodec
...
private[lsp] trait structures_SelectionRangeOptionsCodec:
  ...
  given toJson: Encoder[SelectionRangeOptions] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.workDoneProgress.foreach: v =>
        enc.field("workDoneProgress", v, encode_workDoneProgress)
end structures_SelectionRangeOptionsCodec
...
private[lsp] trait structures_SelectionRangeParamsCodec:
  ...
  given fromJson: Decoder[SelectionRangeParams] =
    ...
    val decode_textDocument: Decoder[structures.TextDocumentIdentifier] =
      structures.TextDocumentIdentifier.fromJson
    val decode_positions: Decoder[Vector[structures.Position]] =
      Decoder.decodeVector(structures.Position.fromJson)
    val decode_workDoneToken: Decoder[aliases.ProgressToken] =
      aliases.ProgressToken.fromJson
    val decode_partialResultToken: Decoder[aliases.ProgressToken] =
      aliases.ProgressToken.fromJson
  ...
  given toJson: Encoder[SelectionRangeParams] =
    ...
    val encode_textDocument: Encoder[structures.TextDocumentIdentifier] =
      structures.TextDocumentIdentifier.toJson
    val encode_positions: Encoder[Vector[structures.Position]] =
      Encoder.encodeVector(structures.Position.toJson)
    val encode_workDoneToken: Encoder[aliases.ProgressToken] =
      aliases.ProgressToken.toJson
    val encode_partialResultToken: Encoder[aliases.ProgressToken] =
      aliases.ProgressToken.toJson
...
end structures_SelectionRangeParamsCodec
...
end structures_SelectionRangeRegistrationOptionsCodec
...
private[lsp] trait structures_SemanticTokensCodec:
  ...
  given fromJson: Decoder[SemanticTokens] =
    // cache all decoders for this type when fromJson first initialised
    val decode_resultId: Decoder[String]               = Decoder.decodeString
    val decode_data: Decoder[Vector[runtime.uinteger]] =
      Decoder.decodeVector(uinteger.fromJson)
    Dec.fromJsonObject: dec =>
      for
        resultId <- dec.getOpt("resultId", decode_resultId)
  ...
  given toJson: Encoder[SemanticTokens] =
    // cache all encoders for this type when toJson first initialised
    val encode_resultId: Encoder[String]               = Encoder.encodeString
    val encode_data: Encoder[Vector[runtime.uinteger]] =
      Encoder.encodeVector(uinteger.toJson)
    Enc.toJsonObject: (enc, a) =>
      a.resultId.foreach: v =>
        enc.field("resultId", v, encode_resultId)
      enc.field("data", a.data, encode_data)
end structures_SemanticTokensCodec
...
private[lsp] trait structures_SemanticTokensClientCapabilitiesCodec:
  ...
  given fromJson: Decoder[SemanticTokensClientCapabilities] =
    ...
    val decode_tokenModifiers: Decoder[Vector[String]] =
      Decoder.decodeVector(Decoder.decodeString)
    val decode_formats: Decoder[Vector[enumerations.TokenFormat]] =
      Decoder.decodeVector(enumerations.TokenFormat.fromJson)
    ...
    Dec.fromJsonObject: dec =>
      for
        ...
        overlappingTokenSupport <- dec.getOpt(
          "overlappingTokenSupport",
          decode_overlappingTokenSupport
        )
        multilineTokenSupport <- dec.getOpt(
          "multilineTokenSupport",
          decode_multilineTokenSupport
        )
        serverCancelSupport <- dec.getOpt(
          "serverCancelSupport",
          decode_serverCancelSupport
        )
        augmentsSyntaxTokens <- dec.getOpt(
          "augmentsSyntaxTokens",
          decode_augmentsSyntaxTokens
        )
  ...
  given toJson: Encoder[SemanticTokensClientCapabilities] =
    ...
    val encode_tokenModifiers: Encoder[Vector[String]] =
      Encoder.encodeVector(Encoder.encodeString)
    val encode_formats: Encoder[Vector[enumerations.TokenFormat]] =
      Encoder.encodeVector(enumerations.TokenFormat.toJson)
...
private[lsp] trait structures_SemanticTokensDeltaCodec:
  ...
  given fromJson: Decoder[SemanticTokensDelta] =
    // cache all decoders for this type when fromJson first initialised
    val decode_resultId: Decoder[String] = Decoder.decodeString
    val decode_edits: Decoder[Vector[structures.SemanticTokensEdit]] =
      Decoder.decodeVector(structures.SemanticTokensEdit.fromJson)
    Dec.fromJsonObject: dec =>
      for
        resultId <- dec.getOpt("resultId", decode_resultId)
  ...
  given toJson: Encoder[SemanticTokensDelta] =
    // cache all encoders for this type when toJson first initialised
    val encode_resultId: Encoder[String] = Encoder.encodeString
    val encode_edits: Encoder[Vector[structures.SemanticTokensEdit]] =
      Encoder.encodeVector(structures.SemanticTokensEdit.toJson)
    Enc.toJsonObject: (enc, a) =>
      a.resultId.foreach: v =>
        enc.field("resultId", v, encode_resultId)
      enc.field("edits", a.edits, encode_edits)
end structures_SemanticTokensDeltaCodec
...
end structures_SemanticTokensDeltaParamsCodec
...
private[lsp] trait structures_SemanticTokensDeltaPartialResultCodec:
  ...
  given fromJson: Decoder[SemanticTokensDeltaPartialResult] =
    ...
    val decode_edits: Decoder[Vector[structures.SemanticTokensEdit]] =
      Decoder.decodeVector(structures.SemanticTokensEdit.fromJson)
    Dec.fromJsonObject: dec =>
      for edits <- dec.get("edits", decode_edits)
  ...
  given toJson: Encoder[SemanticTokensDeltaPartialResult] =
    ...
    Enc.toJsonObject: (enc, a) =>
      enc.field("edits", a.edits, encode_edits)
end structures_SemanticTokensDeltaPartialResultCodec
...
private[lsp] trait structures_SemanticTokensLegendCodec:
  ...
  given toJson: Encoder[SemanticTokensLegend] =
    ...
    Enc.toJsonObject: (enc, a) =>
      enc.field("tokenTypes", a.tokenTypes, encode_tokenTypes)
      enc.field("tokenModifiers", a.tokenModifiers, encode_tokenModifiers)
end structures_SemanticTokensLegendCodec

private[lsp] trait structures_SemanticTokensOptionsCodec:
  import structures.*
  given fromJson: Decoder[SemanticTokensOptions] =
    // cache all decoders for this type when fromJson first initialised
    val decode_legend: Decoder[structures.SemanticTokensLegend] =
      structures.SemanticTokensLegend.fromJson
    val decode_range: Decoder[(Boolean | SemanticTokensOptions.S0)] =
      Dec.union2[Boolean, SemanticTokensOptions.S0](
        Decoder.decodeBoolean,
  ...
  given toJson: Encoder[SemanticTokensOptions] =
    // cache all encoders for this type when toJson first initialised
    val encode_legend: Encoder[structures.SemanticTokensLegend] =
      structures.SemanticTokensLegend.toJson
    val encode_range: Encoder[(Boolean | SemanticTokensOptions.S0)] =
      Enc.union2[Boolean, SemanticTokensOptions.S0](
        Encoder.encodeBoolean,
...
end structures_SemanticTokensOptionsCodec
...
end structures_SemanticTokensParamsCodec
...
private[lsp] trait structures_SemanticTokensPartialResultCodec:
  ...
  given fromJson: Decoder[SemanticTokensPartialResult] =
    ...
    val decode_data: Decoder[Vector[runtime.uinteger]] =
      Decoder.decodeVector(uinteger.fromJson)
    Dec.fromJsonObject: dec =>
      for data <- dec.get("data", decode_data)
  ...
  given toJson: Encoder[SemanticTokensPartialResult] =
    ...
    Enc.toJsonObject: (enc, a) =>
      enc.field("data", a.data, encode_data)
end structures_SemanticTokensPartialResultCodec
...
end structures_SemanticTokensRangeParamsCodec
...
private[lsp] trait structures_SemanticTokensRegistrationOptionsCodec:
  ...
  given fromJson: Decoder[SemanticTokensRegistrationOptions] =
    ...
    val decode_legend: Decoder[structures.SemanticTokensLegend] =
      structures.SemanticTokensLegend.fromJson
    val decode_range
        : Decoder[(Boolean | SemanticTokensRegistrationOptions.S0)] =
      Dec.union2[Boolean, SemanticTokensRegistrationOptions.S0](
        Decoder.decodeBoolean,
  ...
  given toJson: Encoder[SemanticTokensRegistrationOptions] =
    ...
    val encode_legend: Encoder[structures.SemanticTokensLegend] =
      structures.SemanticTokensLegend.toJson
    val encode_range
        : Encoder[(Boolean | SemanticTokensRegistrationOptions.S0)] =
      Enc.union2[Boolean, SemanticTokensRegistrationOptions.S0](
        Encoder.encodeBoolean,
...
end structures_SemanticTokensRegistrationOptionsCodec
...
private[lsp] trait structures_SemanticTokensWorkspaceClientCapabilitiesCodec:
  ...
  given toJson: Encoder[SemanticTokensWorkspaceClientCapabilities] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.refreshSupport.foreach: v =>
        enc.field("refreshSupport", v, encode_refreshSupport)
end structures_SemanticTokensWorkspaceClientCapabilitiesCodec

private[lsp] trait structures_ServerCapabilitiesCodec:
  import structures.*
  given fromJson: Decoder[ServerCapabilities] =
    // cache all decoders for this type when fromJson first initialised
    val decode_positionEncoding: Decoder[enumerations.PositionEncodingKind] =
      enumerations.PositionEncodingKind.fromJson
    val decode_textDocumentSync: Decoder[
      (structures.TextDocumentSyncOptions | enumerations.TextDocumentSyncKind)
    ] = Dec.union2[
      structures.TextDocumentSyncOptions,
      enumerations.TextDocumentSyncKind
    ](
      structures.TextDocumentSyncOptions.fromJson,
      enumerations.TextDocumentSyncKind.fromJson
    )
    val decode_notebookDocumentSync: Decoder[
      ...
      structures.NotebookDocumentSyncOptions.fromJson,
      structures.NotebookDocumentSyncRegistrationOptions.fromJson
    )
    val decode_completionProvider: Decoder[structures.CompletionOptions] =
      structures.CompletionOptions.fromJson
    val decode_hoverProvider: Decoder[(Boolean | structures.HoverOptions)] =
      Dec.union2[Boolean, structures.HoverOptions](
        Decoder.decodeBoolean,
        structures.HoverOptions.fromJson
      )
    val decode_signatureHelpProvider: Decoder[structures.SignatureHelpOptions] =
      structures.SignatureHelpOptions.fromJson
    val decode_declarationProvider: Decoder[
      (Boolean | structures.DeclarationOptions |
        structures.DeclarationRegistrationOptions)
    ] = Dec.union3[
      Boolean,
      structures.DeclarationOptions,
      structures.DeclarationRegistrationOptions
    ](
      Decoder.decodeBoolean,
      structures.DeclarationOptions.fromJson,
      structures.DeclarationRegistrationOptions.fromJson
    )
    val decode_definitionProvider
        : Decoder[(Boolean | structures.DefinitionOptions)] =
      Dec.union2[Boolean, structures.DefinitionOptions](
        Decoder.decodeBoolean,
        structures.DefinitionOptions.fromJson
      )
    val decode_typeDefinitionProvider: Decoder[
      ...
      Decoder.decodeBoolean,
      structures.TypeDefinitionOptions.fromJson,
      structures.TypeDefinitionRegistrationOptions.fromJson
    )
    val decode_implementationProvider: Decoder[
      (Boolean | structures.ImplementationOptions |
        structures.ImplementationRegistrationOptions)
    ] = Dec.union3[
      Boolean,
      structures.ImplementationOptions,
      structures.ImplementationRegistrationOptions
    ](
      Decoder.decodeBoolean,
      structures.ImplementationOptions.fromJson,
      structures.ImplementationRegistrationOptions.fromJson
    )
    val decode_referencesProvider
        : Decoder[(Boolean | structures.ReferenceOptions)] =
      Dec.union2[Boolean, structures.ReferenceOptions](
        Decoder.decodeBoolean,
        structures.ReferenceOptions.fromJson
      )
    val decode_documentHighlightProvider
        : Decoder[(Boolean | structures.DocumentHighlightOptions)] =
      Dec.union2[Boolean, structures.DocumentHighlightOptions](
        Decoder.decodeBoolean,
        structures.DocumentHighlightOptions.fromJson
      )
    val decode_documentSymbolProvider
        : Decoder[(Boolean | structures.DocumentSymbolOptions)] =
      Dec.union2[Boolean, structures.DocumentSymbolOptions](
        Decoder.decodeBoolean,
        structures.DocumentSymbolOptions.fromJson
      )
    val decode_codeActionProvider
        : Decoder[(Boolean | structures.CodeActionOptions)] =
      Dec.union2[Boolean, structures.CodeActionOptions](
        Decoder.decodeBoolean,
        structures.CodeActionOptions.fromJson
      )
    val decode_codeLensProvider: Decoder[structures.CodeLensOptions] =
      structures.CodeLensOptions.fromJson
    val decode_documentLinkProvider: Decoder[structures.DocumentLinkOptions] =
      structures.DocumentLinkOptions.fromJson
    val decode_colorProvider: Decoder[
      (Boolean | structures.DocumentColorOptions |
        structures.DocumentColorRegistrationOptions)
    ] = Dec.union3[
      Boolean,
      structures.DocumentColorOptions,
      structures.DocumentColorRegistrationOptions
    ](
      Decoder.decodeBoolean,
      structures.DocumentColorOptions.fromJson,
      structures.DocumentColorRegistrationOptions.fromJson
    )
    val decode_workspaceSymbolProvider
        : Decoder[(Boolean | structures.WorkspaceSymbolOptions)] =
      Dec.union2[Boolean, structures.WorkspaceSymbolOptions](
        Decoder.decodeBoolean,
        structures.WorkspaceSymbolOptions.fromJson
      )
    val decode_documentFormattingProvider
        : Decoder[(Boolean | structures.DocumentFormattingOptions)] =
      Dec.union2[Boolean, structures.DocumentFormattingOptions](
        Decoder.decodeBoolean,
        structures.DocumentFormattingOptions.fromJson
      )
    val decode_documentRangeFormattingProvider
        : Decoder[(Boolean | structures.DocumentRangeFormattingOptions)] =
      Dec.union2[Boolean, structures.DocumentRangeFormattingOptions](
        Decoder.decodeBoolean,
        structures.DocumentRangeFormattingOptions.fromJson
      )
    val decode_documentOnTypeFormattingProvider
        : Decoder[structures.DocumentOnTypeFormattingOptions] =
      structures.DocumentOnTypeFormattingOptions.fromJson
    val decode_renameProvider: Decoder[(Boolean | structures.RenameOptions)] =
      Dec.union2[Boolean, structures.RenameOptions](
        Decoder.decodeBoolean,
        structures.RenameOptions.fromJson
      )
    val decode_foldingRangeProvider: Decoder[
      (Boolean | structures.FoldingRangeOptions |
        structures.FoldingRangeRegistrationOptions)
    ] = Dec.union3[
      Boolean,
      structures.FoldingRangeOptions,
      structures.FoldingRangeRegistrationOptions
    ](
      Decoder.decodeBoolean,
      structures.FoldingRangeOptions.fromJson,
      structures.FoldingRangeRegistrationOptions.fromJson
    )
    val decode_selectionRangeProvider: Decoder[
      (Boolean | structures.SelectionRangeOptions |
        structures.SelectionRangeRegistrationOptions)
    ] = Dec.union3[
      Boolean,
      structures.SelectionRangeOptions,
      structures.SelectionRangeRegistrationOptions
    ](
      Decoder.decodeBoolean,
      structures.SelectionRangeOptions.fromJson,
      structures.SelectionRangeRegistrationOptions.fromJson
    )
    val decode_executeCommandProvider
        : Decoder[structures.ExecuteCommandOptions] =
      structures.ExecuteCommandOptions.fromJson
    val decode_callHierarchyProvider: Decoder[
      (Boolean | structures.CallHierarchyOptions |
        structures.CallHierarchyRegistrationOptions)
    ] = Dec.union3[
      Boolean,
      structures.CallHierarchyOptions,
      structures.CallHierarchyRegistrationOptions
    ](
      Decoder.decodeBoolean,
      structures.CallHierarchyOptions.fromJson,
      structures.CallHierarchyRegistrationOptions.fromJson
    )
    val decode_linkedEditingRangeProvider: Decoder[
      (Boolean | structures.LinkedEditingRangeOptions |
        structures.LinkedEditingRangeRegistrationOptions)
    ] = Dec.union3[
      Boolean,
      structures.LinkedEditingRangeOptions,
      structures.LinkedEditingRangeRegistrationOptions
    ](
      Decoder.decodeBoolean,
      structures.LinkedEditingRangeOptions.fromJson,
      structures.LinkedEditingRangeRegistrationOptions.fromJson
    )
    val decode_semanticTokensProvider: Decoder[
      ...
      structures.SemanticTokensOptions.fromJson,
      structures.SemanticTokensRegistrationOptions.fromJson
    )
    val decode_monikerProvider: Decoder[
      (Boolean | structures.MonikerOptions |
        structures.MonikerRegistrationOptions)
    ] = Dec.union3[
      Boolean,
      structures.MonikerOptions,
      structures.MonikerRegistrationOptions
    ](
      Decoder.decodeBoolean,
      structures.MonikerOptions.fromJson,
      structures.MonikerRegistrationOptions.fromJson
    )
    val decode_typeHierarchyProvider: Decoder[
      (Boolean | structures.TypeHierarchyOptions |
        structures.TypeHierarchyRegistrationOptions)
    ] = Dec.union3[
      Boolean,
      structures.TypeHierarchyOptions,
      structures.TypeHierarchyRegistrationOptions
    ](
      Decoder.decodeBoolean,
      structures.TypeHierarchyOptions.fromJson,
      structures.TypeHierarchyRegistrationOptions.fromJson
    )
    val decode_inlineValueProvider: Decoder[
      (Boolean | structures.InlineValueOptions |
        structures.InlineValueRegistrationOptions)
    ] = Dec.union3[
      Boolean,
      structures.InlineValueOptions,
      structures.InlineValueRegistrationOptions
    ](
      Decoder.decodeBoolean,
      structures.InlineValueOptions.fromJson,
      structures.InlineValueRegistrationOptions.fromJson
    )
    val decode_inlayHintProvider: Decoder[
      (Boolean | structures.InlayHintOptions |
        structures.InlayHintRegistrationOptions)
    ] = Dec.union3[
      Boolean,
      structures.InlayHintOptions,
      structures.InlayHintRegistrationOptions
    ](
      Decoder.decodeBoolean,
      structures.InlayHintOptions.fromJson,
      structures.InlayHintRegistrationOptions.fromJson
    )
    val decode_diagnosticProvider: Decoder[
      (structures.DiagnosticOptions | structures.DiagnosticRegistrationOptions)
    ] = Dec.union2[
      structures.DiagnosticOptions,
      structures.DiagnosticRegistrationOptions
    ](
    ...
    Dec.fromJsonObject: dec =>
      for
        positionEncoding <- dec.getOpt(
          "positionEncoding",
          decode_positionEncoding
        )
        textDocumentSync <- dec.getOpt(
          "textDocumentSync",
          decode_textDocumentSync
        )
        notebookDocumentSync <- dec.getOpt(
          "notebookDocumentSync",
          decode_notebookDocumentSync
        )
        completionProvider <- dec.getOpt(
          "completionProvider",
          decode_completionProvider
        )
        hoverProvider <- dec.getOpt("hoverProvider", decode_hoverProvider)
        signatureHelpProvider <- dec.getOpt(
          "signatureHelpProvider",
          decode_signatureHelpProvider
        )
        declarationProvider <- dec.getOpt(
          "declarationProvider",
          decode_declarationProvider
        )
        definitionProvider <- dec.getOpt(
          "definitionProvider",
          decode_definitionProvider
        )
        typeDefinitionProvider <- dec.getOpt(
          "typeDefinitionProvider",
          decode_typeDefinitionProvider
        )
        implementationProvider <- dec.getOpt(
          "implementationProvider",
          decode_implementationProvider
        )
        referencesProvider <- dec.getOpt(
          "referencesProvider",
          decode_referencesProvider
        )
        documentHighlightProvider <- dec.getOpt(
          "documentHighlightProvider",
          decode_documentHighlightProvider
        )
        documentSymbolProvider <- dec.getOpt(
          "documentSymbolProvider",
          decode_documentSymbolProvider
        )
        codeActionProvider <- dec.getOpt(
          "codeActionProvider",
          decode_codeActionProvider
        )
        codeLensProvider <- dec.getOpt(
          "codeLensProvider",
          decode_codeLensProvider
        )
        documentLinkProvider <- dec.getOpt(
          "documentLinkProvider",
          decode_documentLinkProvider
        )
        colorProvider <- dec.getOpt("colorProvider", decode_colorProvider)
        workspaceSymbolProvider <- dec.getOpt(
          "workspaceSymbolProvider",
          decode_workspaceSymbolProvider
        )
        documentFormattingProvider <- dec.getOpt(
          "documentFormattingProvider",
          decode_documentFormattingProvider
        )
        documentRangeFormattingProvider <- dec.getOpt(
          "documentRangeFormattingProvider",
          decode_documentRangeFormattingProvider
        )
        documentOnTypeFormattingProvider <- dec.getOpt(
          "documentOnTypeFormattingProvider",
          decode_documentOnTypeFormattingProvider
        )
        renameProvider <- dec.getOpt("renameProvider", decode_renameProvider)
        foldingRangeProvider <- dec.getOpt(
          "foldingRangeProvider",
          decode_foldingRangeProvider
        )
        selectionRangeProvider <- dec.getOpt(
          "selectionRangeProvider",
          decode_selectionRangeProvider
        )
        executeCommandProvider <- dec.getOpt(
          "executeCommandProvider",
          decode_executeCommandProvider
        )
        callHierarchyProvider <- dec.getOpt(
          "callHierarchyProvider",
          decode_callHierarchyProvider
        )
        linkedEditingRangeProvider <- dec.getOpt(
          "linkedEditingRangeProvider",
          decode_linkedEditingRangeProvider
        )
        semanticTokensProvider <- dec.getOpt(
          "semanticTokensProvider",
          decode_semanticTokensProvider
        )
        monikerProvider <- dec.getOpt("monikerProvider", decode_monikerProvider)
        typeHierarchyProvider <- dec.getOpt(
          "typeHierarchyProvider",
          decode_typeHierarchyProvider
        )
        inlineValueProvider <- dec.getOpt(
          "inlineValueProvider",
          decode_inlineValueProvider
        )
        inlayHintProvider <- dec.getOpt(
          "inlayHintProvider",
          decode_inlayHintProvider
        )
        diagnosticProvider <- dec.getOpt(
          "diagnosticProvider",
  ...
  given toJson: Encoder[ServerCapabilities] =
    // cache all encoders for this type when toJson first initialised
    val encode_positionEncoding: Encoder[enumerations.PositionEncodingKind] =
      enumerations.PositionEncodingKind.toJson
    val encode_textDocumentSync: Encoder[
      (structures.TextDocumentSyncOptions | enumerations.TextDocumentSyncKind)
    ] = Enc.union2[
      structures.TextDocumentSyncOptions,
      enumerations.TextDocumentSyncKind
    ](
      structures.TextDocumentSyncOptions.toJson,
      enumerations.TextDocumentSyncKind.toJson
    )
    val encode_notebookDocumentSync: Encoder[
      (structures.NotebookDocumentSyncOptions |
        structures.NotebookDocumentSyncRegistrationOptions)
    ] = Enc.union2[
      structures.NotebookDocumentSyncOptions,
      ...
      structures.NotebookDocumentSyncOptions.toJson,
      structures.NotebookDocumentSyncRegistrationOptions.toJson
    )
    val encode_completionProvider: Encoder[structures.CompletionOptions] =
      structures.CompletionOptions.toJson
    val encode_hoverProvider: Encoder[(Boolean | structures.HoverOptions)] =
      Enc.union2[Boolean, structures.HoverOptions](
        Encoder.encodeBoolean,
        structures.HoverOptions.toJson
      )
    val encode_signatureHelpProvider: Encoder[structures.SignatureHelpOptions] =
      structures.SignatureHelpOptions.toJson
    val encode_declarationProvider: Encoder[
      (Boolean | structures.DeclarationOptions |
        structures.DeclarationRegistrationOptions)
    ] = Enc.union3[
      Boolean,
      ...
      Encoder.encodeBoolean,
      structures.DeclarationOptions.toJson,
      structures.DeclarationRegistrationOptions.toJson
    )
    val encode_definitionProvider
        : Encoder[(Boolean | structures.DefinitionOptions)] =
      Enc.union2[Boolean, structures.DefinitionOptions](
        Encoder.encodeBoolean,
        structures.DefinitionOptions.toJson
      )
    val encode_typeDefinitionProvider: Encoder[
      (Boolean | structures.TypeDefinitionOptions |
        structures.TypeDefinitionRegistrationOptions)
    ] = Enc.union3[
      Boolean,
      ...
      Encoder.encodeBoolean,
      structures.TypeDefinitionOptions.toJson,
      structures.TypeDefinitionRegistrationOptions.toJson
    )
    val encode_implementationProvider: Encoder[
      (Boolean | structures.ImplementationOptions |
        structures.ImplementationRegistrationOptions)
    ] = Enc.union3[
      Boolean,
      ...
      Encoder.encodeBoolean,
      structures.ImplementationOptions.toJson,
      structures.ImplementationRegistrationOptions.toJson
    )
    val encode_referencesProvider
        : Encoder[(Boolean | structures.ReferenceOptions)] =
      Enc.union2[Boolean, structures.ReferenceOptions](
        Encoder.encodeBoolean,
        structures.ReferenceOptions.toJson
      )
    val encode_documentHighlightProvider
        : Encoder[(Boolean | structures.DocumentHighlightOptions)] =
      Enc.union2[Boolean, structures.DocumentHighlightOptions](
        Encoder.encodeBoolean,
        structures.DocumentHighlightOptions.toJson
      )
    val encode_documentSymbolProvider
        : Encoder[(Boolean | structures.DocumentSymbolOptions)] =
      Enc.union2[Boolean, structures.DocumentSymbolOptions](
        Encoder.encodeBoolean,
        structures.DocumentSymbolOptions.toJson
      )
    val encode_codeActionProvider
        : Encoder[(Boolean | structures.CodeActionOptions)] =
      Enc.union2[Boolean, structures.CodeActionOptions](
        Encoder.encodeBoolean,
        structures.CodeActionOptions.toJson
      )
    val encode_codeLensProvider: Encoder[structures.CodeLensOptions] =
      structures.CodeLensOptions.toJson
    val encode_documentLinkProvider: Encoder[structures.DocumentLinkOptions] =
      structures.DocumentLinkOptions.toJson
    val encode_colorProvider: Encoder[
      (Boolean | structures.DocumentColorOptions |
        structures.DocumentColorRegistrationOptions)
    ] = Enc.union3[
      Boolean,
      ...
      Encoder.encodeBoolean,
      structures.DocumentColorOptions.toJson,
      structures.DocumentColorRegistrationOptions.toJson
    )
    val encode_workspaceSymbolProvider
        : Encoder[(Boolean | structures.WorkspaceSymbolOptions)] =
      Enc.union2[Boolean, structures.WorkspaceSymbolOptions](
        Encoder.encodeBoolean,
        structures.WorkspaceSymbolOptions.toJson
      )
    val encode_documentFormattingProvider
        : Encoder[(Boolean | structures.DocumentFormattingOptions)] =
      Enc.union2[Boolean, structures.DocumentFormattingOptions](
        Encoder.encodeBoolean,
        structures.DocumentFormattingOptions.toJson
      )
    val encode_documentRangeFormattingProvider
        : Encoder[(Boolean | structures.DocumentRangeFormattingOptions)] =
      Enc.union2[Boolean, structures.DocumentRangeFormattingOptions](
        Encoder.encodeBoolean,
        structures.DocumentRangeFormattingOptions.toJson
      )
    val encode_documentOnTypeFormattingProvider
        : Encoder[structures.DocumentOnTypeFormattingOptions] =
      structures.DocumentOnTypeFormattingOptions.toJson
    val encode_renameProvider: Encoder[(Boolean | structures.RenameOptions)] =
      Enc.union2[Boolean, structures.RenameOptions](
        Encoder.encodeBoolean,
        structures.RenameOptions.toJson
      )
    val encode_foldingRangeProvider: Encoder[
      (Boolean | structures.FoldingRangeOptions |
        structures.FoldingRangeRegistrationOptions)
    ] = Enc.union3[
      Boolean,
      ...
      Encoder.encodeBoolean,
      structures.FoldingRangeOptions.toJson,
      structures.FoldingRangeRegistrationOptions.toJson
    )
    val encode_selectionRangeProvider: Encoder[
      (Boolean | structures.SelectionRangeOptions |
        structures.SelectionRangeRegistrationOptions)
    ] = Enc.union3[
      Boolean,
      ...
      Encoder.encodeBoolean,
      structures.SelectionRangeOptions.toJson,
      structures.SelectionRangeRegistrationOptions.toJson
    )
    val encode_executeCommandProvider
        : Encoder[structures.ExecuteCommandOptions] =
      structures.ExecuteCommandOptions.toJson
    val encode_callHierarchyProvider: Encoder[
      (Boolean | structures.CallHierarchyOptions |
        structures.CallHierarchyRegistrationOptions)
    ] = Enc.union3[
      Boolean,
      ...
      Encoder.encodeBoolean,
      structures.CallHierarchyOptions.toJson,
      structures.CallHierarchyRegistrationOptions.toJson
    )
    val encode_linkedEditingRangeProvider: Encoder[
      (Boolean | structures.LinkedEditingRangeOptions |
        structures.LinkedEditingRangeRegistrationOptions)
    ] = Enc.union3[
      Boolean,
      ...
      Encoder.encodeBoolean,
      structures.LinkedEditingRangeOptions.toJson,
      structures.LinkedEditingRangeRegistrationOptions.toJson
    )
    val encode_semanticTokensProvider: Encoder[
      (structures.SemanticTokensOptions |
        structures.SemanticTokensRegistrationOptions)
    ] = Enc.union2[
      structures.SemanticTokensOptions,
      ...
      structures.SemanticTokensOptions.toJson,
      structures.SemanticTokensRegistrationOptions.toJson
    )
    val encode_monikerProvider: Encoder[
      (Boolean | structures.MonikerOptions |
        structures.MonikerRegistrationOptions)
    ] = Enc.union3[
      Boolean,
      ...
      Encoder.encodeBoolean,
      structures.MonikerOptions.toJson,
      structures.MonikerRegistrationOptions.toJson
    )
    val encode_typeHierarchyProvider: Encoder[
      (Boolean | structures.TypeHierarchyOptions |
        structures.TypeHierarchyRegistrationOptions)
    ] = Enc.union3[
      Boolean,
      ...
      Encoder.encodeBoolean,
      structures.TypeHierarchyOptions.toJson,
      structures.TypeHierarchyRegistrationOptions.toJson
    )
    val encode_inlineValueProvider: Encoder[
      (Boolean | structures.InlineValueOptions |
        structures.InlineValueRegistrationOptions)
    ] = Enc.union3[
      Boolean,
      ...
      Encoder.encodeBoolean,
      structures.InlineValueOptions.toJson,
      structures.InlineValueRegistrationOptions.toJson
    )
    val encode_inlayHintProvider: Encoder[
      (Boolean | structures.InlayHintOptions |
        structures.InlayHintRegistrationOptions)
    ] = Enc.union3[
      Boolean,
      ...
      Encoder.encodeBoolean,
      structures.InlayHintOptions.toJson,
      structures.InlayHintRegistrationOptions.toJson
    )
    val encode_diagnosticProvider: Encoder[
      (structures.DiagnosticOptions | structures.DiagnosticRegistrationOptions)
    ] = Enc.union2[
      structures.DiagnosticOptions,
      structures.DiagnosticRegistrationOptions
    ...
    Enc.toJsonObject: (enc, a) =>
      ...
      a.documentHighlightProvider.foreach: v =>
        enc.field(
          "documentHighlightProvider",
          v,
          encode_documentHighlightProvider
        )
      ...
      a.documentFormattingProvider.foreach: v =>
        enc.field(
          "documentFormattingProvider",
          v,
          encode_documentFormattingProvider
        )
      a.documentRangeFormattingProvider.foreach: v =>
        enc.field(
          "documentRangeFormattingProvider",
          v,
          encode_documentRangeFormattingProvider
        )
      a.documentOnTypeFormattingProvider.foreach: v =>
        enc.field(
          "documentOnTypeFormattingProvider",
          v,
          encode_documentOnTypeFormattingProvider
        )
      ...
      a.linkedEditingRangeProvider.foreach: v =>
        enc.field(
          "linkedEditingRangeProvider",
          v,
          encode_linkedEditingRangeProvider
        )
...
private[lsp] trait structures_ShowDocumentClientCapabilitiesCodec:
  ...
  given fromJson: Decoder[ShowDocumentClientCapabilities] =
    ...
    Dec.fromJsonObject: dec =>
      for support <- dec.get("support", decode_support)
...
end structures_ShowDocumentClientCapabilitiesCodec
...
end structures_ShowDocumentParamsCodec
...
private[lsp] trait structures_ShowDocumentResultCodec:
  ...
  given fromJson: Decoder[ShowDocumentResult] =
    ...
    val decode_success: Decoder[Boolean] = Decoder.decodeBoolean
    Dec.fromJsonObject: dec =>
      for success <- dec.get("success", decode_success)
...
end structures_ShowDocumentResultCodec
...
private[lsp] trait structures_ShowMessageParamsCodec:
  ...
  given toJson: Encoder[ShowMessageParams] =
    ...
    Enc.toJsonObject: (enc, a) =>
      enc.field("type", a.`type`, encode_type)
      enc.field("message", a.message, encode_message)
end structures_ShowMessageParamsCodec
...
private[lsp] trait structures_ShowMessageRequestParamsCodec:
  ...
  given fromJson: Decoder[ShowMessageRequestParams] =
    ...
    val decode_type: Decoder[enumerations.MessageType] =
      enumerations.MessageType.fromJson
    val decode_message: Decoder[String] = Decoder.decodeString
    val decode_actions: Decoder[Vector[structures.MessageActionItem]] =
      Decoder.decodeVector(structures.MessageActionItem.fromJson)
    Dec.fromJsonObject: dec =>
      for
        `type`  <- dec.get("type", decode_type)
        message <- dec.get("message", decode_message)
  ...
  given toJson: Encoder[ShowMessageRequestParams] =
    ...
    val encode_type: Encoder[enumerations.MessageType] =
      enumerations.MessageType.toJson
    val encode_message: Encoder[String] = Encoder.encodeString
    val encode_actions: Encoder[Vector[structures.MessageActionItem]] =
      Encoder.encodeVector(structures.MessageActionItem.toJson)
    Enc.toJsonObject: (enc, a) =>
      enc.field("type", a.`type`, encode_type)
      enc.field("message", a.message, encode_message)
      a.actions.foreach: v =>
...
end structures_ShowMessageRequestParamsCodec

private[lsp] trait structures_SignatureHelpCodec:
  import structures.*
  given fromJson: Decoder[SignatureHelp] =
    // cache all decoders for this type when fromJson first initialised
    val decode_signatures: Decoder[Vector[structures.SignatureInformation]] =
      Decoder.decodeVector(structures.SignatureInformation.fromJson)
  ...
  given toJson: Encoder[SignatureHelp] =
    // cache all encoders for this type when toJson first initialised
    val encode_signatures: Encoder[Vector[structures.SignatureInformation]] =
      Encoder.encodeVector(structures.SignatureInformation.toJson)
...
end structures_SignatureHelpCodec
  ...
  given fromJson: Decoder[SignatureHelpClientCapabilities] =
    ...
    Dec.fromJsonObject: dec =>
      for
        ...
        signatureInformation <- dec.getOpt(
          "signatureInformation",
          decode_signatureInformation
        )
        contextSupport <- dec.getOpt("contextSupport", decode_contextSupport)
...
private[lsp] trait structures_SignatureHelpContextCodec:
  ...
  given fromJson: Decoder[SignatureHelpContext] =
    // cache all decoders for this type when fromJson first initialised
    val decode_triggerKind: Decoder[enumerations.SignatureHelpTriggerKind] =
      enumerations.SignatureHelpTriggerKind.fromJson
    val decode_triggerCharacter: Decoder[String] = Decoder.decodeString
    val decode_isRetrigger: Decoder[Boolean]     = Decoder.decodeBoolean
    val decode_activeSignatureHelp: Decoder[structures.SignatureHelp] =
      structures.SignatureHelp.fromJson
    Dec.fromJsonObject: dec =>
      for
        triggerKind      <- dec.get("triggerKind", decode_triggerKind)
        triggerCharacter <- dec.getOpt(
        ...
        activeSignatureHelp <- dec.getOpt(
          "activeSignatureHelp",
          decode_activeSignatureHelp
        )
  ...
  given toJson: Encoder[SignatureHelpContext] =
    // cache all encoders for this type when toJson first initialised
    val encode_triggerKind: Encoder[enumerations.SignatureHelpTriggerKind] =
      enumerations.SignatureHelpTriggerKind.toJson
    val encode_triggerCharacter: Encoder[String] = Encoder.encodeString
    val encode_isRetrigger: Encoder[Boolean]     = Encoder.encodeBoolean
    val encode_activeSignatureHelp: Encoder[structures.SignatureHelp] =
      structures.SignatureHelp.toJson
    Enc.toJsonObject: (enc, a) =>
      enc.field("triggerKind", a.triggerKind, encode_triggerKind)
      a.triggerCharacter.foreach: v =>
        enc.field("triggerCharacter", v, encode_triggerCharacter)
...
end structures_SignatureHelpContextCodec
...
private[lsp] trait structures_SignatureHelpOptionsCodec:
  ...
  given fromJson: Decoder[SignatureHelpOptions] =
    ...
    val decode_triggerCharacters: Decoder[Vector[String]] =
      Decoder.decodeVector(Decoder.decodeString)
    val decode_retriggerCharacters: Decoder[Vector[String]] =
      Decoder.decodeVector(Decoder.decodeString)
    val decode_workDoneProgress: Decoder[Boolean] = Decoder.decodeBoolean
    Dec.fromJsonObject: dec =>
      for
        ...
        retriggerCharacters <- dec.getOpt(
          "retriggerCharacters",
          decode_retriggerCharacters
        )
        workDoneProgress <- dec.getOpt(
          "workDoneProgress",
          decode_workDoneProgress
  ...
  given toJson: Encoder[SignatureHelpOptions] =
    ...
    val encode_triggerCharacters: Encoder[Vector[String]] =
      Encoder.encodeVector(Encoder.encodeString)
    val encode_retriggerCharacters: Encoder[Vector[String]] =
      Encoder.encodeVector(Encoder.encodeString)
    val encode_workDoneProgress: Encoder[Boolean] = Encoder.encodeBoolean
    Enc.toJsonObject: (enc, a) =>
      a.triggerCharacters.foreach: v =>
...
end structures_SignatureHelpOptionsCodec

private[lsp] trait structures_SignatureHelpParamsCodec:
  import structures.*
  given fromJson: Decoder[SignatureHelpParams] =
    // cache all decoders for this type when fromJson first initialised
    val decode_context: Decoder[structures.SignatureHelpContext] =
      structures.SignatureHelpContext.fromJson
    val decode_textDocument: Decoder[structures.TextDocumentIdentifier] =
      structures.TextDocumentIdentifier.fromJson
    val decode_position: Decoder[structures.Position] =
      structures.Position.fromJson
  ...
  given toJson: Encoder[SignatureHelpParams] =
    // cache all encoders for this type when toJson first initialised
    val encode_context: Encoder[structures.SignatureHelpContext] =
      structures.SignatureHelpContext.toJson
    val encode_textDocument: Encoder[structures.TextDocumentIdentifier] =
      structures.TextDocumentIdentifier.toJson
    val encode_position: Encoder[structures.Position] =
      structures.Position.toJson
...
end structures_SignatureHelpParamsCodec
...
end structures_SignatureHelpRegistrationOptionsCodec
...
private[lsp] trait structures_SignatureInformationCodec:
  ...
  given fromJson: Decoder[SignatureInformation] =
    ...
    val decode_parameters: Decoder[Vector[structures.ParameterInformation]] =
      Decoder.decodeVector(structures.ParameterInformation.fromJson)
    val decode_activeParameter: Decoder[runtime.uinteger] = uinteger.fromJson
    Dec.fromJsonObject: dec =>
      for
        label           <- dec.get("label", decode_label)
  ...
  given toJson: Encoder[SignatureInformation] =
    ...
    val encode_parameters: Encoder[Vector[structures.ParameterInformation]] =
      Encoder.encodeVector(structures.ParameterInformation.toJson)
    val encode_activeParameter: Encoder[runtime.uinteger] = uinteger.toJson
    Enc.toJsonObject: (enc, a) =>
      enc.field("label", a.label, encode_label)
      a.documentation.foreach: v =>
...
private[lsp] trait structures_StaticRegistrationOptionsCodec:
  ...
  given fromJson: Decoder[StaticRegistrationOptions] =
    ...
    val decode_id: Decoder[String] = Decoder.decodeString
    Dec.fromJsonObject: dec =>
      for id <- dec.getOpt("id", decode_id)
...
end structures_SymbolInformationCodec
...
private[lsp] trait structures_TextDocumentChangeRegistrationOptionsCodec:
  ...
  given fromJson: Decoder[TextDocumentChangeRegistrationOptions] =
    // cache all decoders for this type when fromJson first initialised
    val decode_syncKind: Decoder[enumerations.TextDocumentSyncKind] =
      enumerations.TextDocumentSyncKind.fromJson
    val decode_documentSelector: Decoder[aliases.DocumentSelector] =
      aliases.DocumentSelector.fromJson
    Dec.fromJsonObject: dec =>
  ...
  given toJson: Encoder[TextDocumentChangeRegistrationOptions] =
    // cache all encoders for this type when toJson first initialised
    val encode_syncKind: Encoder[enumerations.TextDocumentSyncKind] =
      enumerations.TextDocumentSyncKind.toJson
    val encode_documentSelector: Encoder[aliases.DocumentSelector] =
      aliases.DocumentSelector.toJson
    Enc.toJsonObject: (enc, a) =>
...
end structures_TextDocumentChangeRegistrationOptionsCodec
...
private[lsp] trait structures_TextDocumentClientCapabilitiesCodec:
  ...
  given fromJson: Decoder[TextDocumentClientCapabilities] =
    ...
    val decode_hover: Decoder[structures.HoverClientCapabilities] =
      structures.HoverClientCapabilities.fromJson
    val decode_signatureHelp
        : Decoder[structures.SignatureHelpClientCapabilities] =
      structures.SignatureHelpClientCapabilities.fromJson
    val decode_declaration: Decoder[structures.DeclarationClientCapabilities] =
      structures.DeclarationClientCapabilities.fromJson
    val decode_definition: Decoder[structures.DefinitionClientCapabilities] =
      structures.DefinitionClientCapabilities.fromJson
    val decode_typeDefinition
        : Decoder[structures.TypeDefinitionClientCapabilities] =
      structures.TypeDefinitionClientCapabilities.fromJson
    val decode_implementation
        : Decoder[structures.ImplementationClientCapabilities] =
      structures.ImplementationClientCapabilities.fromJson
    val decode_references: Decoder[structures.ReferenceClientCapabilities] =
      structures.ReferenceClientCapabilities.fromJson
    val decode_documentHighlight
        : Decoder[structures.DocumentHighlightClientCapabilities] =
      structures.DocumentHighlightClientCapabilities.fromJson
    val decode_documentSymbol
        : Decoder[structures.DocumentSymbolClientCapabilities] =
      structures.DocumentSymbolClientCapabilities.fromJson
    val decode_codeAction: Decoder[structures.CodeActionClientCapabilities] =
      structures.CodeActionClientCapabilities.fromJson
    val decode_codeLens: Decoder[structures.CodeLensClientCapabilities] =
      structures.CodeLensClientCapabilities.fromJson
    val decode_documentLink
        : Decoder[structures.DocumentLinkClientCapabilities] =
      structures.DocumentLinkClientCapabilities.fromJson
    val decode_colorProvider
        : Decoder[structures.DocumentColorClientCapabilities] =
      structures.DocumentColorClientCapabilities.fromJson
    val decode_formatting
        : Decoder[structures.DocumentFormattingClientCapabilities] =
      structures.DocumentFormattingClientCapabilities.fromJson
    val decode_rangeFormatting
        : Decoder[structures.DocumentRangeFormattingClientCapabilities] =
      structures.DocumentRangeFormattingClientCapabilities.fromJson
    val decode_onTypeFormatting
        : Decoder[structures.DocumentOnTypeFormattingClientCapabilities] =
      structures.DocumentOnTypeFormattingClientCapabilities.fromJson
    val decode_rename: Decoder[structures.RenameClientCapabilities] =
      structures.RenameClientCapabilities.fromJson
    val decode_foldingRange
        : Decoder[structures.FoldingRangeClientCapabilities] =
      structures.FoldingRangeClientCapabilities.fromJson
    val decode_selectionRange
        : Decoder[structures.SelectionRangeClientCapabilities] =
      structures.SelectionRangeClientCapabilities.fromJson
    val decode_publishDiagnostics
        : Decoder[structures.PublishDiagnosticsClientCapabilities] =
      structures.PublishDiagnosticsClientCapabilities.fromJson
    val decode_callHierarchy
        : Decoder[structures.CallHierarchyClientCapabilities] =
      structures.CallHierarchyClientCapabilities.fromJson
    val decode_semanticTokens
        : Decoder[structures.SemanticTokensClientCapabilities] =
      structures.SemanticTokensClientCapabilities.fromJson
    val decode_linkedEditingRange
        : Decoder[structures.LinkedEditingRangeClientCapabilities] =
      structures.LinkedEditingRangeClientCapabilities.fromJson
    val decode_moniker: Decoder[structures.MonikerClientCapabilities] =
      structures.MonikerClientCapabilities.fromJson
    val decode_typeHierarchy
        : Decoder[structures.TypeHierarchyClientCapabilities] =
      structures.TypeHierarchyClientCapabilities.fromJson
    val decode_inlineValue: Decoder[structures.InlineValueClientCapabilities] =
      structures.InlineValueClientCapabilities.fromJson
    val decode_inlayHint: Decoder[structures.InlayHintClientCapabilities] =
    ...
    Dec.fromJsonObject: dec =>
      for
        ...
        documentHighlight <- dec.getOpt(
          "documentHighlight",
          decode_documentHighlight
        )
        ...
        onTypeFormatting <- dec.getOpt(
          "onTypeFormatting",
          decode_onTypeFormatting
        )
        rename         <- dec.getOpt("rename", decode_rename)
        foldingRange   <- dec.getOpt("foldingRange", decode_foldingRange)
        selectionRange <- dec.getOpt("selectionRange", decode_selectionRange)
        publishDiagnostics <- dec.getOpt(
          "publishDiagnostics",
          decode_publishDiagnostics
        )
  ...
  given toJson: Encoder[TextDocumentClientCapabilities] =
    ...
    val encode_hover: Encoder[structures.HoverClientCapabilities] =
      structures.HoverClientCapabilities.toJson
    val encode_signatureHelp
        : Encoder[structures.SignatureHelpClientCapabilities] =
      structures.SignatureHelpClientCapabilities.toJson
    val encode_declaration: Encoder[structures.DeclarationClientCapabilities] =
      structures.DeclarationClientCapabilities.toJson
    val encode_definition: Encoder[structures.DefinitionClientCapabilities] =
      structures.DefinitionClientCapabilities.toJson
    val encode_typeDefinition
        : Encoder[structures.TypeDefinitionClientCapabilities] =
      structures.TypeDefinitionClientCapabilities.toJson
    val encode_implementation
        : Encoder[structures.ImplementationClientCapabilities] =
      structures.ImplementationClientCapabilities.toJson
    val encode_references: Encoder[structures.ReferenceClientCapabilities] =
      structures.ReferenceClientCapabilities.toJson
    val encode_documentHighlight
        : Encoder[structures.DocumentHighlightClientCapabilities] =
      structures.DocumentHighlightClientCapabilities.toJson
    val encode_documentSymbol
        : Encoder[structures.DocumentSymbolClientCapabilities] =
      structures.DocumentSymbolClientCapabilities.toJson
    val encode_codeAction: Encoder[structures.CodeActionClientCapabilities] =
      structures.CodeActionClientCapabilities.toJson
    val encode_codeLens: Encoder[structures.CodeLensClientCapabilities] =
      structures.CodeLensClientCapabilities.toJson
    val encode_documentLink
        : Encoder[structures.DocumentLinkClientCapabilities] =
      structures.DocumentLinkClientCapabilities.toJson
    val encode_colorProvider
        : Encoder[structures.DocumentColorClientCapabilities] =
      structures.DocumentColorClientCapabilities.toJson
    val encode_formatting
        : Encoder[structures.DocumentFormattingClientCapabilities] =
      structures.DocumentFormattingClientCapabilities.toJson
    val encode_rangeFormatting
        : Encoder[structures.DocumentRangeFormattingClientCapabilities] =
      structures.DocumentRangeFormattingClientCapabilities.toJson
    val encode_onTypeFormatting
        : Encoder[structures.DocumentOnTypeFormattingClientCapabilities] =
      structures.DocumentOnTypeFormattingClientCapabilities.toJson
    val encode_rename: Encoder[structures.RenameClientCapabilities] =
      structures.RenameClientCapabilities.toJson
    val encode_foldingRange
        : Encoder[structures.FoldingRangeClientCapabilities] =
      structures.FoldingRangeClientCapabilities.toJson
    val encode_selectionRange
        : Encoder[structures.SelectionRangeClientCapabilities] =
      structures.SelectionRangeClientCapabilities.toJson
    val encode_publishDiagnostics
        : Encoder[structures.PublishDiagnosticsClientCapabilities] =
      structures.PublishDiagnosticsClientCapabilities.toJson
    val encode_callHierarchy
        : Encoder[structures.CallHierarchyClientCapabilities] =
      structures.CallHierarchyClientCapabilities.toJson
    val encode_semanticTokens
        : Encoder[structures.SemanticTokensClientCapabilities] =
      structures.SemanticTokensClientCapabilities.toJson
    val encode_linkedEditingRange
        : Encoder[structures.LinkedEditingRangeClientCapabilities] =
      structures.LinkedEditingRangeClientCapabilities.toJson
    val encode_moniker: Encoder[structures.MonikerClientCapabilities] =
      structures.MonikerClientCapabilities.toJson
    val encode_typeHierarchy
        : Encoder[structures.TypeHierarchyClientCapabilities] =
      structures.TypeHierarchyClientCapabilities.toJson
    val encode_inlineValue: Encoder[structures.InlineValueClientCapabilities] =
      structures.InlineValueClientCapabilities.toJson
    val encode_inlayHint: Encoder[structures.InlayHintClientCapabilities] =
...
private[lsp] trait structures_TextDocumentIdentifierCodec:
  ...
  given toJson: Encoder[TextDocumentIdentifier] =
    ...
    Enc.toJsonObject: (enc, a) =>
      enc.field("uri", a.uri, encode_uri)
end structures_TextDocumentIdentifierCodec
...
end structures_TextDocumentItemCodec
...
private[lsp] trait structures_TextDocumentPositionParamsCodec:
  ...
  given toJson: Encoder[TextDocumentPositionParams] =
    ...
    Enc.toJsonObject: (enc, a) =>
      enc.field("textDocument", a.textDocument, encode_textDocument)
      enc.field("position", a.position, encode_position)
end structures_TextDocumentPositionParamsCodec
...
private[lsp] trait structures_TextDocumentRegistrationOptionsCodec:
  ...
  given toJson: Encoder[TextDocumentRegistrationOptions] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.documentSelector.foreach: v =>
        enc.field("documentSelector", v, encode_documentSelector)
end structures_TextDocumentRegistrationOptionsCodec
...
end structures_TextDocumentSaveRegistrationOptionsCodec
  ...
  given fromJson: Decoder[TextDocumentSyncClientCapabilities] =
    ...
    Dec.fromJsonObject: dec =>
      for
        ...
        willSaveWaitUntil <- dec.getOpt(
          "willSaveWaitUntil",
          decode_willSaveWaitUntil
        )
...
end structures_TextDocumentSyncClientCapabilitiesCodec
...
private[lsp] trait structures_TextDocumentSyncOptionsCodec:
  ...
  given fromJson: Decoder[TextDocumentSyncOptions] =
    ...
    val decode_change: Decoder[enumerations.TextDocumentSyncKind] =
      enumerations.TextDocumentSyncKind.fromJson
    val decode_willSave: Decoder[Boolean]          = Decoder.decodeBoolean
    val decode_willSaveWaitUntil: Decoder[Boolean] = Decoder.decodeBoolean
    val decode_save: Decoder[(Boolean | structures.SaveOptions)] =
      Dec.union2[Boolean, structures.SaveOptions](
        Decoder.decodeBoolean,
        structures.SaveOptions.fromJson
      )
    Dec.fromJsonObject: dec =>
      for
  ...
  given toJson: Encoder[TextDocumentSyncOptions] =
    ...
    val encode_change: Encoder[enumerations.TextDocumentSyncKind] =
      enumerations.TextDocumentSyncKind.toJson
    val encode_willSave: Encoder[Boolean]          = Encoder.encodeBoolean
    val encode_willSaveWaitUntil: Encoder[Boolean] = Encoder.encodeBoolean
    val encode_save: Encoder[(Boolean | structures.SaveOptions)] =
      Enc.union2[Boolean, structures.SaveOptions](
        Encoder.encodeBoolean,
        structures.SaveOptions.toJson
      )
    Enc.toJsonObject: (enc, a) =>
...
end structures_TextDocumentSyncOptionsCodec
...
private[lsp] trait structures_TypeDefinitionClientCapabilitiesCodec:
  ...
  given toJson: Encoder[TypeDefinitionClientCapabilities] =
    ...
    Enc.toJsonObject: (enc, a) =>
      ...
      a.linkSupport.foreach: v =>
        enc.field("linkSupport", v, encode_linkSupport)
end structures_TypeDefinitionClientCapabilitiesCodec
...
private[lsp] trait structures_TypeDefinitionOptionsCodec:
  ...
  given toJson: Encoder[TypeDefinitionOptions] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.workDoneProgress.foreach: v =>
        enc.field("workDoneProgress", v, encode_workDoneProgress)
end structures_TypeDefinitionOptionsCodec
...
end structures_TypeDefinitionParamsCodec
...
end structures_TypeDefinitionRegistrationOptionsCodec
...
private[lsp] trait structures_TypeHierarchyClientCapabilitiesCodec:
  ...
  given toJson: Encoder[TypeHierarchyClientCapabilities] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.dynamicRegistration.foreach: v =>
        enc.field("dynamicRegistration", v, encode_dynamicRegistration)
end structures_TypeHierarchyClientCapabilitiesCodec
...
end structures_TypeHierarchyItemCodec
...
private[lsp] trait structures_TypeHierarchyOptionsCodec:
  ...
  given toJson: Encoder[TypeHierarchyOptions] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.workDoneProgress.foreach: v =>
        enc.field("workDoneProgress", v, encode_workDoneProgress)
end structures_TypeHierarchyOptionsCodec
...
end structures_TypeHierarchyPrepareParamsCodec
...
end structures_TypeHierarchyRegistrationOptionsCodec

private[lsp] trait structures_TypeHierarchySubtypesParamsCodec:
  import structures.*
  given fromJson: Decoder[TypeHierarchySubtypesParams] =
    // cache all decoders for this type when fromJson first initialised
    val decode_item: Decoder[structures.TypeHierarchyItem] =
      structures.TypeHierarchyItem.fromJson
    val decode_workDoneToken: Decoder[aliases.ProgressToken] =
      aliases.ProgressToken.fromJson
    val decode_partialResultToken: Decoder[aliases.ProgressToken] =
      aliases.ProgressToken.fromJson
  ...
  given toJson: Encoder[TypeHierarchySubtypesParams] =
    // cache all encoders for this type when toJson first initialised
    val encode_item: Encoder[structures.TypeHierarchyItem] =
      structures.TypeHierarchyItem.toJson
    val encode_workDoneToken: Encoder[aliases.ProgressToken] =
      aliases.ProgressToken.toJson
    val encode_partialResultToken: Encoder[aliases.ProgressToken] =
      aliases.ProgressToken.toJson
...
end structures_TypeHierarchySubtypesParamsCodec
...
end structures_TypeHierarchySupertypesParamsCodec
...
private[lsp] trait structures_UnchangedDocumentDiagnosticReportCodec:
  ...
  given toJson: Encoder[UnchangedDocumentDiagnosticReport] =
    ...
    Enc.toJsonObject: (enc, a) =>
      enc.field("kind", a.kind, encode_kind)
      enc.field("resultId", a.resultId, encode_resultId)
end structures_UnchangedDocumentDiagnosticReportCodec
...
private[lsp] trait structures_UnregistrationCodec:
  ...
  given toJson: Encoder[Unregistration] =
    ...
    Enc.toJsonObject: (enc, a) =>
      enc.field("id", a.id, encode_id)
      enc.field("method", a.method, encode_method)
end structures_UnregistrationCodec

private[lsp] trait structures_UnregistrationParamsCodec:
  import structures.*
  given fromJson: Decoder[UnregistrationParams] =
    // cache all decoders for this type when fromJson first initialised
    val decode_unregisterations: Decoder[Vector[structures.Unregistration]] =
      Decoder.decodeVector(structures.Unregistration.fromJson)
    Dec.fromJsonObject: dec =>
      for unregisterations <- dec.get(
          "unregisterations",
          decode_unregisterations
        )
  ...
  given toJson: Encoder[UnregistrationParams] =
    // cache all encoders for this type when toJson first initialised
    val encode_unregisterations: Encoder[Vector[structures.Unregistration]] =
      Encoder.encodeVector(structures.Unregistration.toJson)
    Enc.toJsonObject: (enc, a) =>
      enc.field("unregisterations", a.unregisterations, encode_unregisterations)
end structures_UnregistrationParamsCodec
...
private[lsp] trait structures_VersionedNotebookDocumentIdentifierCodec:
  ...
  given toJson: Encoder[VersionedNotebookDocumentIdentifier] =
    ...
    Enc.toJsonObject: (enc, a) =>
      enc.field("version", a.version, encode_version)
      enc.field("uri", a.uri, encode_uri)
end structures_VersionedNotebookDocumentIdentifierCodec
...
private[lsp] trait structures_VersionedTextDocumentIdentifierCodec:
  ...
  given toJson: Encoder[VersionedTextDocumentIdentifier] =
    ...
    Enc.toJsonObject: (enc, a) =>
      enc.field("version", a.version, encode_version)
      enc.field("uri", a.uri, encode_uri)
end structures_VersionedTextDocumentIdentifierCodec
...
private[lsp] trait structures_WillSaveTextDocumentParamsCodec:
  ...
  given fromJson: Decoder[WillSaveTextDocumentParams] =
    ...
    val decode_textDocument: Decoder[structures.TextDocumentIdentifier] =
      structures.TextDocumentIdentifier.fromJson
    val decode_reason: Decoder[enumerations.TextDocumentSaveReason] =
      enumerations.TextDocumentSaveReason.fromJson
    Dec.fromJsonObject: dec =>
      for
        textDocument <- dec.get("textDocument", decode_textDocument)
  ...
  given toJson: Encoder[WillSaveTextDocumentParams] =
    ...
    val encode_textDocument: Encoder[structures.TextDocumentIdentifier] =
      structures.TextDocumentIdentifier.toJson
    val encode_reason: Encoder[enumerations.TextDocumentSaveReason] =
      enumerations.TextDocumentSaveReason.toJson
    Enc.toJsonObject: (enc, a) =>
      enc.field("textDocument", a.textDocument, encode_textDocument)
      enc.field("reason", a.reason, encode_reason)
end structures_WillSaveTextDocumentParamsCodec
...
private[lsp] trait structures_WindowClientCapabilitiesCodec:
  ...
  given fromJson: Decoder[WindowClientCapabilities] =
    // cache all decoders for this type when fromJson first initialised
    val decode_workDoneProgress: Decoder[Boolean] = Decoder.decodeBoolean
    val decode_showMessage
        : Decoder[structures.ShowMessageRequestClientCapabilities] =
      structures.ShowMessageRequestClientCapabilities.fromJson
    val decode_showDocument
        : Decoder[structures.ShowDocumentClientCapabilities] =
      structures.ShowDocumentClientCapabilities.fromJson
    Dec.fromJsonObject: dec =>
      for
        workDoneProgress <- dec.getOpt(
          "workDoneProgress",
  ...
  given toJson: Encoder[WindowClientCapabilities] =
    // cache all encoders for this type when toJson first initialised
    val encode_workDoneProgress: Encoder[Boolean] = Encoder.encodeBoolean
    val encode_showMessage
        : Encoder[structures.ShowMessageRequestClientCapabilities] =
      structures.ShowMessageRequestClientCapabilities.toJson
    val encode_showDocument
        : Encoder[structures.ShowDocumentClientCapabilities] =
      structures.ShowDocumentClientCapabilities.toJson
    Enc.toJsonObject: (enc, a) =>
      a.workDoneProgress.foreach: v =>
        enc.field("workDoneProgress", v, encode_workDoneProgress)
...
end structures_WindowClientCapabilitiesCodec
...
end structures_WorkDoneProgressBeginCodec
...
private[lsp] trait structures_WorkDoneProgressCancelParamsCodec:
  ...
  given fromJson: Decoder[WorkDoneProgressCancelParams] =
    ...
    val decode_token: Decoder[aliases.ProgressToken] =
      aliases.ProgressToken.fromJson
    Dec.fromJsonObject: dec =>
      for token <- dec.get("token", decode_token)
  ...
  given toJson: Encoder[WorkDoneProgressCancelParams] =
    ...
    Enc.toJsonObject: (enc, a) =>
      enc.field("token", a.token, encode_token)
end structures_WorkDoneProgressCancelParamsCodec
...
private[lsp] trait structures_WorkDoneProgressCreateParamsCodec:
  ...
  given toJson: Encoder[WorkDoneProgressCreateParams] =
    ...
    Enc.toJsonObject: (enc, a) =>
      enc.field("token", a.token, encode_token)
end structures_WorkDoneProgressCreateParamsCodec
...
private[lsp] trait structures_WorkDoneProgressEndCodec:
  ...
  given toJson: Encoder[WorkDoneProgressEnd] =
    ...
    Enc.toJsonObject: (enc, a) =>
      ...
      a.message.foreach: v =>
        enc.field("message", v, encode_message)
end structures_WorkDoneProgressEndCodec
...
private[lsp] trait structures_WorkDoneProgressOptionsCodec:
  ...
  given toJson: Encoder[WorkDoneProgressOptions] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.workDoneProgress.foreach: v =>
        enc.field("workDoneProgress", v, encode_workDoneProgress)
end structures_WorkDoneProgressOptionsCodec
...
private[lsp] trait structures_WorkDoneProgressParamsCodec:
  ...
  given fromJson: Decoder[WorkDoneProgressParams] =
    ...
    val decode_workDoneToken: Decoder[aliases.ProgressToken] =
      aliases.ProgressToken.fromJson
    Dec.fromJsonObject: dec =>
      for workDoneToken <- dec.getOpt("workDoneToken", decode_workDoneToken)
  ...
  given toJson: Encoder[WorkDoneProgressParams] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.workDoneToken.foreach: v =>
        enc.field("workDoneToken", v, encode_workDoneToken)
end structures_WorkDoneProgressParamsCodec
...
end structures_WorkDoneProgressReportCodec
...
private[lsp] trait structures_WorkspaceClientCapabilitiesCodec:
  ...
  given fromJson: Decoder[WorkspaceClientCapabilities] =
    ...
    val decode_workspaceEdit
        : Decoder[structures.WorkspaceEditClientCapabilities] =
      structures.WorkspaceEditClientCapabilities.fromJson
    val decode_didChangeConfiguration
        : Decoder[structures.DidChangeConfigurationClientCapabilities] =
      structures.DidChangeConfigurationClientCapabilities.fromJson
    val decode_didChangeWatchedFiles
        : Decoder[structures.DidChangeWatchedFilesClientCapabilities] =
      structures.DidChangeWatchedFilesClientCapabilities.fromJson
    val decode_symbol: Decoder[structures.WorkspaceSymbolClientCapabilities] =
      structures.WorkspaceSymbolClientCapabilities.fromJson
    val decode_executeCommand
        : Decoder[structures.ExecuteCommandClientCapabilities] =
      structures.ExecuteCommandClientCapabilities.fromJson
    ...
    val decode_semanticTokens
        : Decoder[structures.SemanticTokensWorkspaceClientCapabilities] =
      structures.SemanticTokensWorkspaceClientCapabilities.fromJson
    val decode_codeLens
        : Decoder[structures.CodeLensWorkspaceClientCapabilities] =
      structures.CodeLensWorkspaceClientCapabilities.fromJson
    val decode_fileOperations
        : Decoder[structures.FileOperationClientCapabilities] =
      structures.FileOperationClientCapabilities.fromJson
    val decode_inlineValue
        : Decoder[structures.InlineValueWorkspaceClientCapabilities] =
      structures.InlineValueWorkspaceClientCapabilities.fromJson
    val decode_inlayHint
        : Decoder[structures.InlayHintWorkspaceClientCapabilities] =
      structures.InlayHintWorkspaceClientCapabilities.fromJson
    ...
    Dec.fromJsonObject: dec =>
      for
        ...
        didChangeConfiguration <- dec.getOpt(
          "didChangeConfiguration",
          decode_didChangeConfiguration
        )
        didChangeWatchedFiles <- dec.getOpt(
          "didChangeWatchedFiles",
          decode_didChangeWatchedFiles
        )
  ...
  given toJson: Encoder[WorkspaceClientCapabilities] =
    ...
    val encode_workspaceEdit
        : Encoder[structures.WorkspaceEditClientCapabilities] =
      structures.WorkspaceEditClientCapabilities.toJson
    val encode_didChangeConfiguration
        : Encoder[structures.DidChangeConfigurationClientCapabilities] =
      structures.DidChangeConfigurationClientCapabilities.toJson
    val encode_didChangeWatchedFiles
        : Encoder[structures.DidChangeWatchedFilesClientCapabilities] =
      structures.DidChangeWatchedFilesClientCapabilities.toJson
    val encode_symbol: Encoder[structures.WorkspaceSymbolClientCapabilities] =
      structures.WorkspaceSymbolClientCapabilities.toJson
    val encode_executeCommand
        : Encoder[structures.ExecuteCommandClientCapabilities] =
      structures.ExecuteCommandClientCapabilities.toJson
    ...
    val encode_semanticTokens
        : Encoder[structures.SemanticTokensWorkspaceClientCapabilities] =
      structures.SemanticTokensWorkspaceClientCapabilities.toJson
    val encode_codeLens
        : Encoder[structures.CodeLensWorkspaceClientCapabilities] =
      structures.CodeLensWorkspaceClientCapabilities.toJson
    val encode_fileOperations
        : Encoder[structures.FileOperationClientCapabilities] =
      structures.FileOperationClientCapabilities.toJson
    val encode_inlineValue
        : Encoder[structures.InlineValueWorkspaceClientCapabilities] =
      structures.InlineValueWorkspaceClientCapabilities.toJson
    val encode_inlayHint
        : Encoder[structures.InlayHintWorkspaceClientCapabilities] =
      structures.InlayHintWorkspaceClientCapabilities.toJson
...
private[lsp] trait structures_WorkspaceDiagnosticParamsCodec:
  ...
  given fromJson: Decoder[WorkspaceDiagnosticParams] =
    // cache all decoders for this type when fromJson first initialised
    val decode_identifier: Decoder[String] = Decoder.decodeString
    val decode_previousResultIds: Decoder[Vector[structures.PreviousResultId]] =
      Decoder.decodeVector(structures.PreviousResultId.fromJson)
    val decode_workDoneToken: Decoder[aliases.ProgressToken] =
      aliases.ProgressToken.fromJson
    val decode_partialResultToken: Decoder[aliases.ProgressToken] =
      aliases.ProgressToken.fromJson
    Dec.fromJsonObject: dec =>
      for
        identifier        <- dec.getOpt("identifier", decode_identifier)
        previousResultIds <- dec.get(
          "previousResultIds",
          decode_previousResultIds
        )
        workDoneToken      <- dec.getOpt("workDoneToken", decode_workDoneToken)
        partialResultToken <- dec.getOpt(
          "partialResultToken",
  ...
  given toJson: Encoder[WorkspaceDiagnosticParams] =
    // cache all encoders for this type when toJson first initialised
    val encode_identifier: Encoder[String] = Encoder.encodeString
    val encode_previousResultIds: Encoder[Vector[structures.PreviousResultId]] =
      Encoder.encodeVector(structures.PreviousResultId.toJson)
    val encode_workDoneToken: Encoder[aliases.ProgressToken] =
      aliases.ProgressToken.toJson
    val encode_partialResultToken: Encoder[aliases.ProgressToken] =
      aliases.ProgressToken.toJson
...
end structures_WorkspaceDiagnosticParamsCodec
...
private[lsp] trait structures_WorkspaceDiagnosticReportCodec:
  ...
  given fromJson: Decoder[WorkspaceDiagnosticReport] =
    // cache all decoders for this type when fromJson first initialised
    val decode_items
        : Decoder[Vector[aliases.WorkspaceDocumentDiagnosticReport]] =
      Decoder.decodeVector(aliases.WorkspaceDocumentDiagnosticReport.fromJson)
    Dec.fromJsonObject: dec =>
      for items <- dec.get("items", decode_items)
  ...
  given toJson: Encoder[WorkspaceDiagnosticReport] =
    // cache all encoders for this type when toJson first initialised
    val encode_items
        : Encoder[Vector[aliases.WorkspaceDocumentDiagnosticReport]] =
      Encoder.encodeVector(aliases.WorkspaceDocumentDiagnosticReport.toJson)
    Enc.toJsonObject: (enc, a) =>
      enc.field("items", a.items, encode_items)
end structures_WorkspaceDiagnosticReportCodec
...
private[lsp] trait structures_WorkspaceDiagnosticReportPartialResultCodec:
  ...
  given toJson: Encoder[WorkspaceDiagnosticReportPartialResult] =
    ...
    Enc.toJsonObject: (enc, a) =>
      enc.field("items", a.items, encode_items)
end structures_WorkspaceDiagnosticReportPartialResultCodec
...
private[lsp] trait structures_WorkspaceEditCodec:
  ...
  given fromJson: Decoder[WorkspaceEdit] =
    // cache all decoders for this type when fromJson first initialised
    val decode_changes
        : Decoder[Map[runtime.DocumentUri, Vector[structures.TextEdit]]] =
      Decoder.decodeMap(
        KeyDecoder.decodeKeyString.map(runtime.DocumentUri.apply),
        Decoder.decodeVector(structures.TextEdit.fromJson)
      )
    val decode_documentChanges: Decoder[Vector[
      (structures.TextDocumentEdit | structures.CreateFile |
        structures.RenameFile | structures.DeleteFile)
    ]] = Decoder.decodeVector(
      Dec.union4[
        structures.TextDocumentEdit,
        structures.CreateFile,
        structures.RenameFile,
        structures.DeleteFile
      ](
        structures.TextDocumentEdit.fromJson,
        structures.CreateFile.fromJson,
        structures.RenameFile.fromJson,
        structures.DeleteFile.fromJson
      )
    )
    val decode_changeAnnotations: Decoder[
      Map[aliases.ChangeAnnotationIdentifier, structures.ChangeAnnotation]
    ] = Decoder.decodeMap(
      KeyDecoder.decodeKeyString.map(aliases.ChangeAnnotationIdentifier.apply),
      structures.ChangeAnnotation.fromJson
    )
    Dec.fromJsonObject: dec =>
      for
        changes         <- dec.getOpt("changes", decode_changes)
        documentChanges <- dec.getOpt("documentChanges", decode_documentChanges)
        changeAnnotations <- dec.getOpt(
          "changeAnnotations",
          decode_changeAnnotations
        )
      yield WorkspaceEdit(
        changes,
        documentChanges,
  ...
  given toJson: Encoder[WorkspaceEdit] =
    // cache all encoders for this type when toJson first initialised
    val encode_changes
        : Encoder[Map[runtime.DocumentUri, Vector[structures.TextEdit]]] =
      Encoder.encodeMap(
        KeyEncoder.encodeKeyString.contramap(_.value),
        Encoder.encodeVector(structures.TextEdit.toJson)
      )
    val encode_documentChanges: Encoder[Vector[
      (structures.TextDocumentEdit | structures.CreateFile |
        structures.RenameFile | structures.DeleteFile)
    ]] = Encoder.encodeVector(
      Enc.union4[
        ...
        structures.TextDocumentEdit.toJson,
        structures.CreateFile.toJson,
        structures.RenameFile.toJson,
        structures.DeleteFile.toJson
      )
    )
    val encode_changeAnnotations: Encoder[
      Map[aliases.ChangeAnnotationIdentifier, structures.ChangeAnnotation]
    ] = Encoder.encodeMap(
      KeyEncoder.encodeKeyString.contramap(_.value),
      structures.ChangeAnnotation.toJson
    )
    Enc.toJsonObject: (enc, a) =>
      a.changes.foreach: v =>
...
end structures_WorkspaceEditCodec
...
private[lsp] trait structures_WorkspaceEditClientCapabilitiesCodec:
  ...
  given fromJson: Decoder[WorkspaceEditClientCapabilities] =
    ...
    val decode_resourceOperations
        : Decoder[Vector[enumerations.ResourceOperationKind]] =
      Decoder.decodeVector(enumerations.ResourceOperationKind.fromJson)
    val decode_failureHandling: Decoder[enumerations.FailureHandlingKind] =
    ...
    Dec.fromJsonObject: dec =>
      for
        documentChanges <- dec.getOpt("documentChanges", decode_documentChanges)
        resourceOperations <- dec.getOpt(
          "resourceOperations",
          decode_resourceOperations
        )
        failureHandling <- dec.getOpt("failureHandling", decode_failureHandling)
        normalizesLineEndings <- dec.getOpt(
          "normalizesLineEndings",
          decode_normalizesLineEndings
        )
        changeAnnotationSupport <- dec.getOpt(
  ...
  given toJson: Encoder[WorkspaceEditClientCapabilities] =
    ...
    val encode_resourceOperations
        : Encoder[Vector[enumerations.ResourceOperationKind]] =
      Encoder.encodeVector(enumerations.ResourceOperationKind.toJson)
    val encode_failureHandling: Encoder[enumerations.FailureHandlingKind] =
...
private[lsp] trait structures_WorkspaceFolderCodec:
  ...
  given toJson: Encoder[WorkspaceFolder] =
    ...
    Enc.toJsonObject: (enc, a) =>
      enc.field("uri", a.uri, encode_uri)
      enc.field("name", a.name, encode_name)
end structures_WorkspaceFolderCodec

private[lsp] trait structures_WorkspaceFoldersChangeEventCodec:
  import structures.*
  given fromJson: Decoder[WorkspaceFoldersChangeEvent] =
    // cache all decoders for this type when fromJson first initialised
    val decode_added: Decoder[Vector[structures.WorkspaceFolder]] =
      Decoder.decodeVector(structures.WorkspaceFolder.fromJson)
    val decode_removed: Decoder[Vector[structures.WorkspaceFolder]] =
      Decoder.decodeVector(structures.WorkspaceFolder.fromJson)
    Dec.fromJsonObject: dec =>
      for
  ...
  given toJson: Encoder[WorkspaceFoldersChangeEvent] =
    // cache all encoders for this type when toJson first initialised
    val encode_added: Encoder[Vector[structures.WorkspaceFolder]] =
      Encoder.encodeVector(structures.WorkspaceFolder.toJson)
    val encode_removed: Encoder[Vector[structures.WorkspaceFolder]] =
      Encoder.encodeVector(structures.WorkspaceFolder.toJson)
    Enc.toJsonObject: (enc, a) =>
      enc.field("added", a.added, encode_added)
      enc.field("removed", a.removed, encode_removed)
end structures_WorkspaceFoldersChangeEventCodec
...
private[lsp] trait structures_WorkspaceFoldersInitializeParamsCodec:
  ...
  given fromJson: Decoder[WorkspaceFoldersInitializeParams] =
    ...
    val decode_workspaceFolders: Decoder[Vector[structures.WorkspaceFolder]] =
      Decoder.decodeVector(structures.WorkspaceFolder.fromJson)
    Dec.fromJsonObject: dec =>
      for workspaceFolders <- dec.getOpt(
          "workspaceFolders",
          decode_workspaceFolders
        )
  ...
  given toJson: Encoder[WorkspaceFoldersInitializeParams] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.workspaceFolders.foreach: v =>
        enc.field("workspaceFolders", v, encode_workspaceFolders)
end structures_WorkspaceFoldersInitializeParamsCodec
...
private[lsp] trait structures_WorkspaceFoldersServerCapabilitiesCodec:
  ...
  given fromJson: Decoder[WorkspaceFoldersServerCapabilities] =
    ...
    val decode_changeNotifications: Decoder[(String | Boolean)] =
      Dec.union2[String, Boolean](Decoder.decodeString, Decoder.decodeBoolean)
    Dec.fromJsonObject: dec =>
      for
        supported           <- dec.getOpt("supported", decode_supported)
        changeNotifications <- dec.getOpt(
          "changeNotifications",
          decode_changeNotifications
        )
  ...
  given toJson: Encoder[WorkspaceFoldersServerCapabilities] =
    ...
    val encode_changeNotifications: Encoder[(String | Boolean)] =
      Enc.union2[String, Boolean](Encoder.encodeString, Encoder.encodeBoolean)
    Enc.toJsonObject: (enc, a) =>
...
end structures_WorkspaceFoldersServerCapabilitiesCodec
...
private[lsp] trait structures_WorkspaceSymbolOptionsCodec:
  ...
  given toJson: Encoder[WorkspaceSymbolOptions] =
    ...
    Enc.toJsonObject: (enc, a) =>
      ...
      a.workDoneProgress.foreach: v =>
        enc.field("workDoneProgress", v, encode_workDoneProgress)
end structures_WorkspaceSymbolOptionsCodec
...
end structures_WorkspaceSymbolParamsCodec
...
private[lsp] trait structures_WorkspaceSymbolRegistrationOptionsCodec:
  ...
  given fromJson: Decoder[WorkspaceSymbolRegistrationOptions] =
    ...
    val decode_resolveProvider: Decoder[Boolean] = Decoder.decodeBoolean
    Dec.fromJsonObject: dec =>
      for resolveProvider <- dec.getOpt(
          "resolveProvider",
          decode_resolveProvider
        )
  ...
  given toJson: Encoder[WorkspaceSymbolRegistrationOptions] =
    ...
    Enc.toJsonObject: (enc, a) =>
      a.resolveProvider.foreach: v =>
        enc.field("resolveProvider", v, encode_resolveProvider)
end structures_WorkspaceSymbolRegistrationOptionsCodec
...
end structures_WorkspaceUnchangedDocumentDiagnosticReportCodec
...
private[lsp] trait aliases_Declaration:
  ...
  given fromJson: Decoder[Declaration] =
    Dec
      .union2[structures.Location, Vector[structures.Location]](
        structures.Location.fromJson,
        Decoder.decodeVector(structures.Location.fromJson)
      )
      .asInstanceOf[Decoder[Declaration]]

  given toJson: Encoder[Declaration] =
    Enc
      .union2[structures.Location, Vector[structures.Location]](
        structures.Location.toJson,
        Encoder.encodeVector(structures.Location.toJson)
      )
      .asInstanceOf[Encoder[Declaration]]
end aliases_Declaration
...
private[lsp] trait aliases_Definition:
  ...
  given fromJson: Decoder[Definition] =
    Dec
      ...
      .asInstanceOf[Decoder[Definition]]
  ...
  given toJson: Encoder[Definition] =
    Enc
      ...
      .asInstanceOf[Encoder[Definition]]
end aliases_Definition
  ...
  given fromJson: Decoder[DocumentDiagnosticReport] =
    Dec
      .union2[
        ...
        structures.RelatedFullDocumentDiagnosticReport.fromJson,
        structures.RelatedUnchangedDocumentDiagnosticReport.fromJson
      )
      .asInstanceOf[Decoder[DocumentDiagnosticReport]]
  ...
  given toJson: Encoder[DocumentDiagnosticReport] =
    Enc
      .union2[
        ...
        structures.RelatedFullDocumentDiagnosticReport.toJson,
        structures.RelatedUnchangedDocumentDiagnosticReport.toJson
      )
...
private[lsp] trait aliases_DocumentFilter:
  ...
  given fromJson: Decoder[DocumentFilter] =
    Dec
      .union2[
        aliases.TextDocumentFilter,
        structures.NotebookCellTextDocumentFilter
      ](
        aliases.TextDocumentFilter.fromJson,
        structures.NotebookCellTextDocumentFilter.fromJson
      )
      .asInstanceOf[Decoder[DocumentFilter]]
  ...
  given toJson: Encoder[DocumentFilter] =
    Enc
      .union2[
        ...
        aliases.TextDocumentFilter.toJson,
        structures.NotebookCellTextDocumentFilter.toJson
      )
      .asInstanceOf[Encoder[DocumentFilter]]
end aliases_DocumentFilter

private[lsp] trait aliases_DocumentSelector:

  given fromJson: Decoder[DocumentSelector] =
    Decoder
      .decodeVector(aliases.DocumentFilter.fromJson)
      .asInstanceOf[Decoder[DocumentSelector]]

  given toJson: Encoder[DocumentSelector] =
    Encoder
      .encodeVector(aliases.DocumentFilter.toJson)
      .asInstanceOf[Encoder[DocumentSelector]]
end aliases_DocumentSelector

private[lsp] trait aliases_GlobPattern:

  given fromJson: Decoder[GlobPattern] =
    Dec
      .union2[aliases.Pattern, structures.RelativePattern](
        aliases.Pattern.fromJson,
        structures.RelativePattern.fromJson
      )
      .asInstanceOf[Decoder[GlobPattern]]

  given toJson: Encoder[GlobPattern] =
    Enc
      .union2[aliases.Pattern, structures.RelativePattern](
        aliases.Pattern.toJson,
        structures.RelativePattern.toJson
      )
      .asInstanceOf[Encoder[GlobPattern]]
end aliases_GlobPattern
...
private[lsp] trait aliases_InlineValue:
  ...
  given fromJson: Decoder[InlineValue] =
    Dec
      .union3[
        structures.InlineValueText,
        structures.InlineValueVariableLookup,
        structures.InlineValueEvaluatableExpression
      ](
        structures.InlineValueText.fromJson,
        structures.InlineValueVariableLookup.fromJson,
        structures.InlineValueEvaluatableExpression.fromJson
      )
      .asInstanceOf[Decoder[InlineValue]]
  ...
  given toJson: Encoder[InlineValue] =
    Enc
      .union3[
        ...
        structures.InlineValueText.toJson,
        structures.InlineValueVariableLookup.toJson,
        structures.InlineValueEvaluatableExpression.toJson
      )
      .asInstanceOf[Encoder[InlineValue]]
end aliases_InlineValue

private[lsp] trait aliases_LSPObject:

  given fromJson: Decoder[LSPObject] =
    Decoder
      .decodeMap(KeyDecoder.decodeKeyString, Decoder.decodeJson)
      .asInstanceOf[Decoder[LSPObject]]

  given toJson: Encoder[LSPObject] =
    Encoder
      .encodeMap(KeyEncoder.encodeKeyString, Encoder.encodeJson)
      .asInstanceOf[Encoder[LSPObject]]
end aliases_LSPObject
...
private[lsp] trait aliases_ProgressToken:
  ...
  given fromJson: Decoder[ProgressToken] =
    Dec
      .union2[Int, String](Decoder.decodeInt, Decoder.decodeString)
      .asInstanceOf[Decoder[ProgressToken]]

  given toJson: Encoder[ProgressToken] =
    Enc
      .union2[Int, String](Encoder.encodeInt, Encoder.encodeString)
  ...
  given fromJson: Decoder[WorkspaceDocumentDiagnosticReport] =
    Dec
      .union2[
        ...
        structures.WorkspaceFullDocumentDiagnosticReport.fromJson,
        structures.WorkspaceUnchangedDocumentDiagnosticReport.fromJson
      )
      .asInstanceOf[Decoder[WorkspaceDocumentDiagnosticReport]]
  ...
  given toJson: Encoder[WorkspaceDocumentDiagnosticReport] =
    Enc
      .union2[
        ...
        structures.WorkspaceFullDocumentDiagnosticReport.toJson,
        structures.WorkspaceUnchangedDocumentDiagnosticReport.toJson
      )
      .asInstanceOf[Encoder[WorkspaceDocumentDiagnosticReport]]
end aliases_WorkspaceDocumentDiagnosticReport
