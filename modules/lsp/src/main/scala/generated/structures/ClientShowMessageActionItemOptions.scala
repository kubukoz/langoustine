...
/** @since 3.18.0
  ...
  */
case class ClientShowMessageActionItemOptions(
    additionalPropertiesSupport: Option[Boolean] = None
)
object ClientShowMessageActionItemOptions
    extends codecs.structures_ClientShowMessageActionItemOptionsCodec
