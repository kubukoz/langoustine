...
abstract class CustomNotification[I](method: String)(using
    ifr: Decoder[I],
    ito: Encoder[I]
...
object telemetry:
  ...
  object event
    ...
    override def apply(in: io.circe.Json): PreparedNotification[this.type] =
      super.apply(in)
end telemetry
...
object textDocument:
  ...
  object completion
    ...
    type Out =
      Option[(Vector[structures.CompletionItem] | structures.CompletionList)]
  ...
  object semanticTokens:
    ...
    object full
      ...
      object delta
        ...
        type Out =
          Option[(structures.SemanticTokens | structures.SemanticTokensDelta)]
